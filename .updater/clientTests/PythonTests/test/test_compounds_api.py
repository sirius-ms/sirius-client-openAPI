...
time.sleep(2)
print(api.get_CompoundsApi().import_compounds([path_to_demo_data+"/ms/Bicuculline.ms", path_to_demo_data+"/ms/Kaempferol.ms" ], "temp1"))
time.sleep(2)
print(api.get_CompoundsApi().get_compounds("temp1"))
