...
<dependency>
  ...
  <version>v0.9 on SIRIUS 5.6.3</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:v0.9 on SIRIUS 5.6.3"
  }
```
...
* `target/openapi-java-client-v0.9 on SIRIUS 5.6.3.jar`
* `target/lib/*.jar`
