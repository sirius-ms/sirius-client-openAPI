...
<dependency>
  ...
  <version>v0.9 on SIRIUS 6.0.0-SNAPSHOT</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:v0.9 on SIRIUS 6.0.0-SNAPSHOT"
  }
```
...
* `target/openapi-java-client-v0.9 on SIRIUS 6.0.0-SNAPSHOT.jar`
* `target/lib/*.jar`
