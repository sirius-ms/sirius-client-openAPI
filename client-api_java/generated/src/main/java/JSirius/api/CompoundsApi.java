...
public class CompoundsApi {
     ...
     * @param lcmsFeatureQuality  (optional, default to false)
     ...
     */
    public okhttp3.Call getCompoundCall(String projectId, String cid, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (lcmsFeatureQuality != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("lcmsFeatureQuality", lcmsFeatureQuality));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCompoundValidateBeforeCall(String projectId, String cid, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
        ...
        return getCompoundCall(projectId, cid, topAnnotation, msData, lcmsFeatureQuality, msQuality, _callback);
     ...
     */
    public CompoundId getCompound(String projectId, String cid, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality) throws ApiException {
        ApiResponse<CompoundId> localVarResp = getCompoundWithHttpInfo(projectId, cid, topAnnotation, msData, lcmsFeatureQuality, msQuality);
     ...
     */
    public ApiResponse<CompoundId> getCompoundWithHttpInfo(String projectId, String cid, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality) throws ApiException {
        okhttp3.Call localVarCall = getCompoundValidateBeforeCall(projectId, cid, topAnnotation, msData, lcmsFeatureQuality, msQuality, null);
     ...
     */
    public okhttp3.Call getCompoundAsync(String projectId, String cid, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality, final ApiCallback<CompoundId> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCompoundValidateBeforeCall(projectId, cid, topAnnotation, msData, lcmsFeatureQuality, msQuality, _callback);
        Type localVarReturnType = new TypeToken<CompoundId>(){}.getType();
     ...
     */
    public okhttp3.Call getCompoundsCall(String projectId, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCompoundsValidateBeforeCall(String projectId, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling getCompounds(Async)");
        }

        return getCompoundsCall(projectId, topAnnotation, msData, lcmsFeatureQuality, msQuality, _callback);
     ...
     */
    public List<CompoundId> getCompounds(String projectId, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality) throws ApiException {
        ApiResponse<List<CompoundId>> localVarResp = getCompoundsWithHttpInfo(projectId, topAnnotation, msData, lcmsFeatureQuality, msQuality);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<CompoundId>> getCompoundsWithHttpInfo(String projectId, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality) throws ApiException {
        okhttp3.Call localVarCall = getCompoundsValidateBeforeCall(projectId, topAnnotation, msData, lcmsFeatureQuality, msQuality, null);
     ...
     */
    public okhttp3.Call getCompoundsAsync(String projectId, Boolean topAnnotation, Boolean msData, Boolean lcmsFeatureQuality, Boolean msQuality, final ApiCallback<List<CompoundId>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCompoundsValidateBeforeCall(projectId, topAnnotation, msData, lcmsFeatureQuality, msQuality, _callback);
        Type localVarReturnType = new TypeToken<List<CompoundId>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
