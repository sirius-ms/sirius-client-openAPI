...
class CompoundStatisticsApi:
    ...
    @validate_call
    def compute_compound_fold_changes_experimental(
        self,
        ...
        _param = self._compute_compound_fold_changes_experimental_serialize(
    ...
    @validate_call
    def compute_compound_fold_changes_experimental_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to compute the fold change in.")],
        left_group_name: Annotated[StrictStr, Field(description="name of the left tag group.")],
        right_group_name: Annotated[StrictStr, Field(description="name of the right tag group.")],
    ...
    @validate_call
    def compute_compound_fold_changes_experimental_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to compute the fold change in.")],
        left_group_name: Annotated[StrictStr, Field(description="name of the left tag group.")],
        right_group_name: Annotated[StrictStr, Field(description="name of the right tag group.")],
    ...
    def _compute_compound_fold_changes_experimental_serialize(
        self,
        project_id,
        left_group_name,
        right_group_name,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/projects/{projectId}/compounds/statistics/foldchange/compute',
    ...
    @validate_call
    def delete_compound_fold_changes_experimental(
        self,
        ...
        _param = self._delete_compound_fold_changes_experimental_serialize(
            project_id=project_id,
            left_group_name=left_group_name,
            right_group_name=right_group_name,
            aggregation=aggregation,
    ...
    @validate_call
    def delete_compound_fold_changes_experimental_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to delete from.")],
        left_group_name: Annotated[StrictStr, Field(description="name of the left group.")],
        right_group_name: Annotated[StrictStr, Field(description="name of the right group.")],
    ...
    @validate_call
    def delete_compound_fold_changes_experimental_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to delete from.")],
        left_group_name: Annotated[StrictStr, Field(description="name of the left group.")],
        right_group_name: Annotated[StrictStr, Field(description="name of the right group.")],
    ...
    def _delete_compound_fold_changes_experimental_serialize(
        self,
        project_id,
        left_group_name,
        right_group_name,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/projects/{projectId}/compounds/statistics/foldchanges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_compound_fold_change_table_experimental(
        ...
        _param = self._get_compound_fold_change_table_experimental_serialize(
            project_id=project_id,
            aggregation=aggregation,
            quantification=quantification,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_compound_fold_change_table_experimental_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to read from.")],
        aggregation: Annotated[Optional[AggregationType], Field(description="aggregation type.")] = None,
        quantification: Annotated[Optional[QuantMeasure], Field(description="quantification type.")] = None,
    ...
    @validate_call
    def get_compound_fold_change_table_experimental_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to read from.")],
        aggregation: Annotated[Optional[AggregationType], Field(description="aggregation type.")] = None,
        quantification: Annotated[Optional[QuantMeasure], Field(description="quantification type.")] = None,
    ...
    def _get_compound_fold_change_table_experimental_serialize(
        self,
        project_id,
        aggregation,
        quantification,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/projects/{projectId}/compounds/statistics/foldchanges/stats-table',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_fold_changes_by_compound_experimental(
        ...
        _param = self._get_fold_changes_by_compound_experimental_serialize(
            project_id=project_id,
            object_id=object_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_fold_changes_by_compound_experimental_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to read from.")],
        object_id: Annotated[StrictStr, Field(description="id of the object the fold changes are assigned to.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_fold_changes_by_compound_experimental_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to read from.")],
        object_id: Annotated[StrictStr, Field(description="id of the object the fold changes are assigned to.")],
        _request_timeout: Union[
    ...
    def _get_fold_changes_by_compound_experimental_serialize(
        self,
        project_id,
        object_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/projects/{projectId}/compounds/statistics/foldchanges/{objectId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
