...
class FeaturesApi:
    ...
    def get_quantification(
        ...
        _param = self._get_quantification_serialize(
            project_id=project_id,
            aligned_feature_id=aligned_feature_id,
            type=type,
            _request_auth=_request_auth,
    ...
    def _get_quantification_serialize(
        self,
        project_id,
        aligned_feature_id,
        type,
    ...
    def get_spectral_library_matches(
        ...
        :param candidate_in_chi_key:
        :type candidate_in_chi_key: str
        :param opt_fields:
        :type opt_fields: List[SpectralLibraryMatchOptField]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._get_spectral_library_matches_serialize(
            ...
            candidate_in_chi_key=candidate_in_chi_key,
            opt_fields=opt_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_spectral_library_matches_serialize(
        ...
        if candidate_in_chi_key is not None:
            
            _query_params.append(('candidateInChiKey', candidate_in_chi_key))
    ...
    def get_spectral_library_matches_summary(
        ...
        :type min_similarity: float
        :param candidate_in_chi_key: inchi key of the database compound.
        :type candidate_in_chi_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
