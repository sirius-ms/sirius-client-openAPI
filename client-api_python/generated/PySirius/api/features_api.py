...
class FeaturesApi:
    ...
    def add_de_novo_structure_candidate(
        ...
        skip_existence_check: Annotated[Optional[StrictBool], Field(description="if true, skips a check if this compound is an existing candidate, potentially leading to duplicate structures.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param smiles: smiles
        :type smiles: str
        :param skip_existence_check: if true, skips a check if this compound is an existing candidate, potentially leading to duplicate structures.
        :type skip_existence_check: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _add_de_novo_structure_candidate_serialize(
        ...
        if skip_existence_check is not None:
            
            _query_params.append(('skipExistenceCheck', skip_existence_check))
    ...
    def add_tags_to_aligned_feature_experimental(
        ...
        aligned_feature_id: Annotated[StrictStr, Field(description="feature to add tags to.")],
        ...
        :type project_id: str
        :param aligned_feature_id: feature to add tags to. (required)
        :type aligned_feature_id: str
    ...
    @validate_call
    def add_tags_to_aligned_features_experimental(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to add to.")],
        tag_submission: Annotated[List[TagSubmission], Field(description="tags with the id of feature they shall be added to.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: project-space to add to. (required)
        :type project_id: str
        :param tag_submission: tags with the id of feature they shall be added to. (required)
        ...
        _param = self._add_tags_to_aligned_features_experimental_serialize(
            project_id=project_id,
    ...
    @validate_call
    def add_tags_to_aligned_features_experimental_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to add to.")],
        tag_submission: Annotated[List[TagSubmission], Field(description="tags with the id of feature they shall be added to.")],
        _request_timeout: Union[
    ...
    @validate_call
    def add_tags_to_aligned_features_experimental_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to add to.")],
        tag_submission: Annotated[List[TagSubmission], Field(description="tags with the id of feature they shall be added to.")],
        _request_timeout: Union[
    ...
    def _add_tags_to_aligned_features_experimental_serialize(
        self,
        project_id,
        tag_submission,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/projects/{projectId}/aligned-features/tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_aligned_features_page_experimental(
        self,
        ...
        _param = self._get_aligned_features_page_experimental_serialize(
            project_id=project_id,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def get_aligned_features_page_experimental_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project space to get features (aligned over runs) from.")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    @validate_call
    def get_aligned_features_page_experimental_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project space to get features (aligned over runs) from.")],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    def _get_aligned_features_page_experimental_serialize(
        self,
        project_id,
        page,
        size,
    ...
    @validate_call
    def get_sirius_frag_tree_internal(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to read from.")],
        aligned_feature_id: Annotated[StrictStr, Field(description="feature (aligned over runs) the formula result belongs to.")],
        formula_id: Annotated[StrictStr, Field(description="identifier of the requested formula result")],
        ...
        _param = self._get_sirius_frag_tree_internal_serialize(
            project_id=project_id,
            aligned_feature_id=aligned_feature_id,
            formula_id=formula_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_sirius_frag_tree_internal_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to read from.")],
        aligned_feature_id: Annotated[StrictStr, Field(description="feature (aligned over runs) the formula result belongs to.")],
        formula_id: Annotated[StrictStr, Field(description="identifier of the requested formula result")],
    ...
    @validate_call
    def get_sirius_frag_tree_internal_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to read from.")],
        aligned_feature_id: Annotated[StrictStr, Field(description="feature (aligned over runs) the formula result belongs to.")],
        formula_id: Annotated[StrictStr, Field(description="identifier of the requested formula result")],
    ...
    def _get_sirius_frag_tree_internal_serialize(
        self,
        project_id,
        aligned_feature_id,
        formula_id,
