...
class NPCClassStatisticsApi:
    ...
    @validate_call
    def compute_npc_class_fold_changes_experimental(
        self,
        ...
        _param = self._compute_npc_class_fold_changes_experimental_serialize(
    ...
    @validate_call
    def compute_npc_class_fold_changes_experimental_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to compute the fold change in.")],
        fold_change_job_submission: Annotated[FoldChangeJobSubmission, Field(description="Parameters of fold change job")],
        opt_fields: Annotated[Optional[List[Optional[JobOptField]]], Field(description="job opt fields.")] = None,
    ...
    @validate_call
    def compute_npc_class_fold_changes_experimental_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to compute the fold change in.")],
        fold_change_job_submission: Annotated[FoldChangeJobSubmission, Field(description="Parameters of fold change job")],
        opt_fields: Annotated[Optional[List[Optional[JobOptField]]], Field(description="job opt fields.")] = None,
    ...
    def _compute_npc_class_fold_changes_experimental_serialize(
        self,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/projects/{projectId}/npc-classes/statistics/foldchange/compute',
    ...
    @validate_call
    def delete_npc_class_fold_changes_experimental(
        self,
        ...
        _param = self._delete_npc_class_fold_changes_experimental_serialize(
            project_id=project_id,
    ...
    @validate_call
    def delete_npc_class_fold_changes_experimental_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to delete from.")],
        left_group_name: Annotated[StrictStr, Field(description="name of the left group.")],
        right_group_name: Annotated[StrictStr, Field(description="name of the right group.")],
    ...
    @validate_call
    def delete_npc_class_fold_changes_experimental_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to delete from.")],
        left_group_name: Annotated[StrictStr, Field(description="name of the left group.")],
        right_group_name: Annotated[StrictStr, Field(description="name of the right group.")],
    ...
    def _delete_npc_class_fold_changes_experimental_serialize(
        self,
        project_id,
        left_group_name,
        right_group_name,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/projects/{projectId}/npc-classes/statistics/foldchanges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_npc_class_fold_change_table_experimental(
        self,
        ...
        _param = self._get_npc_class_fold_change_table_experimental_serialize(
            project_id=project_id,
            aggregation=aggregation,
            quantification=quantification,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_npc_class_fold_change_table_experimental_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to read from.")],
        aggregation: Annotated[Optional[AggregationType], Field(description="aggregation type.")] = None,
        quantification: Annotated[Optional[QuantMeasure], Field(description="quantification type.")] = None,
    ...
    @validate_call
    def get_npc_class_fold_change_table_experimental_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to read from.")],
        aggregation: Annotated[Optional[AggregationType], Field(description="aggregation type.")] = None,
        quantification: Annotated[Optional[QuantMeasure], Field(description="quantification type.")] = None,
    ...
    def _get_npc_class_fold_change_table_experimental_serialize(
        self,
        project_id,
        aggregation,
        quantification,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/projects/{projectId}/npc-classes/statistics/foldchanges/stats-table',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
