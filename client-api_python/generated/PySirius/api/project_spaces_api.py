...
class ProjectSpacesApi:
    ...
    def create_project_space(
        self,
        project_id: Annotated[StrictStr, Field(description="unique name/identifier that shall be used to access the newly created project-space.")],
        ...
        :param project_id: unique name/identifier that shall be used to access the newly created project-space. (required)
        :type project_id: str
    ...
    def get_project_spaces_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ProjectSpaceId]]:
        """List all opened project spaces.
    ...
    def open_project_space(
        self,
        project_id: Annotated[StrictStr, Field(description="unique name/identifier that shall be used to access the opened project-space.")],
        path_to_project: StrictStr,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param project_id: unique name/identifier that shall be used to access the opened project-space. (required)
        :type project_id: str
        :param path_to_project: (required)
        :type path_to_project: str
        :param _request_timeout: timeout setting for this request. If one
