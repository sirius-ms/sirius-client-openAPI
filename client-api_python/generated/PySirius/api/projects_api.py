...
class ProjectsApi:
    ...
    def copy_project(
        ...
        """(Deprecated) [DEPRECATED] [INTERNAL] This endpoint is based on local file paths and will likely be removed in future versions of this API.
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PUT /api/projects/{projectId}/copy is deprecated.", DeprecationWarning)
    ...
    def _import_ms_run_data_serialize(
        ...
        if parameters is not None:
            ...
            if hasattr(parameters, 'model_dump'):
                params_dict = parameters.model_dump(mode='json', by_alias=True)
    ...
    @validate_call
    def import_ms_run_data_as_job_locally(
        self,
        project_id: Annotated[StrictStr, Field(description="Project-space to import into.")],
        parameters: Annotated[LcmsSubmissionParameters, Field(description="Parameters for feature alignment and feature finding.")],
        request_body: Annotated[List[StrictStr], Field(description="Local files to import into project.")],
        opt_fields: Annotated[Optional[List[Optional[JobOptField]]], Field(description="Set of optional fields to be included. Use 'none' only to override defaults.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        """(Deprecated) [DEPRECATED] Import and Align full MS-Runs from various formats into the specified project as background job
        ...
        :type parameters: LcmsSubmissionParameters
        :param request_body: Local files to import into project. (required)
    ...
    @validate_call
    def import_ms_run_data_as_job_locally_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project-space to import into.")],
        parameters: Annotated[LcmsSubmissionParameters, Field(description="Parameters for feature alignment and feature finding.")],
        request_body: Annotated[List[StrictStr], Field(description="Local files to import into project.")],
    ...
    @validate_call
    def import_ms_run_data_as_job_locally_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project-space to import into.")],
        parameters: Annotated[LcmsSubmissionParameters, Field(description="Parameters for feature alignment and feature finding.")],
        request_body: Annotated[List[StrictStr], Field(description="Local files to import into project.")],
    ...
    def _import_ms_run_data_as_job_locally_serialize(
        self,
        project_id,
        parameters,
        request_body,
    ...
    @validate_call
    def import_ms_run_data_locally(
        self,
        project_id: Annotated[StrictStr, Field(description="Project to import into.")],
        parameters: Annotated[LcmsSubmissionParameters, Field(description="Parameters for feature alignment and feature finding.")],
        request_body: Annotated[List[StrictStr], Field(description="Local files to import into project.")],
        _request_timeout: Union[
            None,
        ...
        """(Deprecated) [DEPRECATED] Import and Align full MS-Runs from various formats into the specified project  Possible formats (mzML, mzXML)  
        ...
        :param project_id: Project to import into. (required)
        :type project_id: str
        :param parameters: Parameters for feature alignment and feature finding. (required)
        :type parameters: LcmsSubmissionParameters
        :param request_body: Local files to import into project. (required)
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /api/projects/{projectId}/import/ms-local-data-files is deprecated.", DeprecationWarning)

        _param = self._import_ms_run_data_locally_serialize(
            project_id=project_id,
            parameters=parameters,
            request_body=request_body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def import_ms_run_data_locally_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project to import into.")],
        parameters: Annotated[LcmsSubmissionParameters, Field(description="Parameters for feature alignment and feature finding.")],
        request_body: Annotated[List[StrictStr], Field(description="Local files to import into project.")],
    ...
    @validate_call
    def import_ms_run_data_locally_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project to import into.")],
        parameters: Annotated[LcmsSubmissionParameters, Field(description="Parameters for feature alignment and feature finding.")],
        request_body: Annotated[List[StrictStr], Field(description="Local files to import into project.")],
    ...
    def _import_ms_run_data_locally_serialize(
        self,
        project_id,
        parameters,
        request_body,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/projects/{projectId}/import/ms-local-data-files',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def import_preprocessed_data_as_job_locally(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to import into.")],
        ...
        """(Deprecated) [DEPRECATED] Import ms/ms data from the given format into the specified project-space as background job
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /api/projects/{projectId}/import/preprocessed-local-data-files-job is deprecated.", DeprecationWarning)

        _param = self._import_preprocessed_data_as_job_locally_serialize(
            project_id=project_id,
            request_body=request_body,
            ignore_formulas=ignore_formulas,
            allow_ms1_only=allow_ms1_only,
    ...
    @validate_call
    def import_preprocessed_data_as_job_locally_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to import into.")],
        request_body: List[StrictStr],
        ignore_formulas: Optional[StrictBool] = None,
    ...
    @validate_call
    def import_preprocessed_data_as_job_locally_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to import into.")],
        request_body: List[StrictStr],
        ignore_formulas: Optional[StrictBool] = None,
    ...
    def _import_preprocessed_data_as_job_locally_serialize(
        self,
        project_id,
        request_body,
        ignore_formulas,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/projects/{projectId}/import/preprocessed-local-data-files-job',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def import_preprocessed_data_locally(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to import into.")],
        request_body: Annotated[List[StrictStr], Field(description="files to import into project")],
        ignore_formulas: Optional[StrictBool] = None,
        allow_ms1_only: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
        ...
        """(Deprecated) [DEPRECATED] Import already preprocessed ms/ms data from various formats into the specified project  Possible formats (ms, mgf, cef, msp)  
        ...
        :param project_id: project-space to import into. (required)
        :type project_id: str
        :param request_body: files to import into project (required)
        :type request_body: List[str]
        :param ignore_formulas:
        :type ignore_formulas: bool
        :param allow_ms1_only:
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /api/projects/{projectId}/import/preprocessed-local-data-files is deprecated.", DeprecationWarning)

        _param = self._import_preprocessed_data_locally_serialize(
            project_id=project_id,
            request_body=request_body,
            ignore_formulas=ignore_formulas,
            allow_ms1_only=allow_ms1_only,
    ...
    @validate_call
    def import_preprocessed_data_locally_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to import into.")],
        request_body: Annotated[List[StrictStr], Field(description="files to import into project")],
        ignore_formulas: Optional[StrictBool] = None,
    ...
    @validate_call
    def import_preprocessed_data_locally_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="project-space to import into.")],
        request_body: Annotated[List[StrictStr], Field(description="files to import into project")],
        ignore_formulas: Optional[StrictBool] = None,
    ...
    def _import_preprocessed_data_locally_serialize(
        self,
        project_id,
        request_body,
        ignore_formulas,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/projects/{projectId}/import/preprocessed-local-data-files',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
