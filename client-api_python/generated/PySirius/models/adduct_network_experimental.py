...
class AdductNetworkExperimental(BaseModel):
    """
    EXPERIMENTAL: This schema is experimental and may be changed (or even removed) without notice until it is declared stable.
    """ # noqa: E501
    nodes: Optional[List[AdductNodeExperimental]] = None
    edges: Optional[List[AdductEdgeExperimental]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [AdductNodeExperimental.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "edges": [AdductEdgeExperimental.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None
        })
        return _obj
