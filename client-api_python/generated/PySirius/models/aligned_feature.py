...
class AlignedFeature(BaseModel):
    ...
    charge: StrictInt
    detected_adducts: List[StrictStr] = Field(alias="detectedAdducts")
    ...
    __properties: ClassVar[List[str]] = ["alignedFeatureId", "compoundId", "name", "ionMass", "charge", "detectedAdducts", "rtStartSeconds", "rtEndSeconds", "quality", "hasMs1", "hasMsMs", "msData", "topAnnotations", "topAnnotationsDeNovo", "computing"]
