...
class AnnotatedPeak(BaseModel):
    ...
    peak_annotation: Optional[Dict[str, Any]] = Field(default=None, alias="peakAnnotation")
    __properties: ClassVar[List[str]] = ["mass", "intensity", "peakAnnotation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "peakAnnotation": obj.get("peakAnnotation")
        })
        return _obj
