...
ANYVALUE_ANY_OF_SCHEMAS = ["bool", "float", "int", "str"]
...
class AnyValue(BaseModel):
    ...
    # data type: float
    anyof_schema_3_validator: Optional[float] = None
    # data type: bool
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = AnyValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in AnyValue with anyOf schemas: bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AnyValue with anyOf schemas: bool, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
