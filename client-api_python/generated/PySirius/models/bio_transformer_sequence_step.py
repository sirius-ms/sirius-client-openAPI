...
class BioTransformerSequenceStep(BaseModel):
    """
    BioTransformerSequenceStep
    """ # noqa: E501
    metabolic_transformation: Optional[MetabolicTransformation] = Field(default=None, alias="metabolicTransformation")
    iterations: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["metabolicTransformation", "iterations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metabolicTransformation": obj.get("metabolicTransformation"),
