...
class CollisionEnergy(BaseModel):
    """
    
    """ # noqa: E501
    min_energy: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minEnergy")
    max_energy: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxEnergy")
    corrected: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["minEnergy", "maxEnergy", "corrected"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minEnergy": obj.get("minEnergy"),
            "maxEnergy": obj.get("maxEnergy"),
