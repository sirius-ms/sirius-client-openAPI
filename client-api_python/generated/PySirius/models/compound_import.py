...
class CompoundImport(BaseModel):
    """
    CompoundImport
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Some (optional) human-readable name")
    features: List[FeatureImport] = Field(description="The features this compound consists of.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "features": [FeatureImport.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
