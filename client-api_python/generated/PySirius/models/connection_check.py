...
class ConnectionCheck(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["workerInfo", "licenseInfo", "errors", "availableWorkers", "unAvailableWorkers", "supportsAllPredictorTypes", "supportsPosPredictorTypes", "supportsNegPredictorTypes"]
