...
class ConnectionCheck(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["workerInfo", "licenseInfo", "errors", "supportsNegPredictorTypes", "availableWorkers", "unAvailableWorkers", "supportsAllPredictorTypes", "supportsPosPredictorTypes"]
