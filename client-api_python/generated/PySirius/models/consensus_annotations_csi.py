...
class ConsensusAnnotationsCSI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["selectionCriterion", "csiFingerIdStructure", "confidenceExactMatch", "confidenceApproxMatch", "molecularFormula", "compoundClasses", "supportingFeatureIds"]
