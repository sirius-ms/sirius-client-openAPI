...
class FoldChange(BaseModel):
    """
    FoldChange
    """ # noqa: E501
    left_group: Optional[StrictStr] = Field(default=None, alias="leftGroup")
    right_group: Optional[StrictStr] = Field(default=None, alias="rightGroup")
