...
class FragmentNode(BaseModel):
    ...
    mass_error_ppm: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="massErrorPpm")
    score: Optional[Union[StrictFloat, StrictInt]] = None
    intensity: Optional[Union[StrictFloat, StrictInt]] = None
    mz: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["id", "molecularFormula", "ionType", "massDeviationDa", "massErrorPpm", "score", "intensity", "mz"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "massErrorPpm": obj.get("massErrorPpm"),
            "score": obj.get("score"),
