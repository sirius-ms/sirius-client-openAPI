...
class FragmentationTree(BaseModel):
    ...
    root: Optional[FragmentNode] = None
    __properties: ClassVar[List[str]] = ["fragments", "losses", "treeScore", "root"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "root": FragmentNode.from_dict(obj["root"]) if obj.get("root") is not None else None
        })
        return _obj
