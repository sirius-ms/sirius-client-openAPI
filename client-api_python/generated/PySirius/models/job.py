...
class Job(BaseModel):
    ...
    progress: Optional[JobProgress] = Field(default=None, description="Optional progress information of this job")
    ...
    job_effect: Optional[JobEffect] = Field(default=None, description="Effect this job has. The affected ids are added, removed or modified.  Null if job does not affect features/compounds  Not available/null if affected Ids are not requested", alias="jobEffect")
