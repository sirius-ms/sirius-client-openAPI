...
class PageGuiInfo(BaseModel):
    ...
    content: Optional[List[GuiInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [GuiInfo.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
