...
class PageStructureCandidateScored(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["totalPages", "totalElements", "size", "content", "number", "sort", "last", "numberOfElements", "first", "pageable", "empty"]
