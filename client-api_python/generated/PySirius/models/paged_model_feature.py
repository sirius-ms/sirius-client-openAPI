...
class PagedModelFeature(BaseModel):
    """
    PagedModelFeature
    """ # noqa: E501
    content: Optional[List[Feature]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [Feature.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
