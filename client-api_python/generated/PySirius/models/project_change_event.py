...
class ProjectChangeEvent(BaseModel):
    ...
    def event_type_validate_enum(cls, value):
        ...
        if value not in set(['PROJECT_OPENED', 'PROJECT_MOVED', 'PROJECT_CLOSED', 'FEATURE_CREATED', 'FEATURE_UPDATED', 'FEATURE_DELETED', 'RESULT_CREATED', 'RESULT_UPDATED', 'RESULT_DELETED']):
            raise ValueError("must be one of enum values ('PROJECT_OPENED', 'PROJECT_MOVED', 'PROJECT_CLOSED', 'FEATURE_CREATED', 'FEATURE_UPDATED', 'FEATURE_DELETED', 'RESULT_CREATED', 'RESULT_UPDATED', 'RESULT_DELETED')")
        return value
