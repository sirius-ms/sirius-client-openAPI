...
class Run(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Informative, human-readable name of the run")
    source: Optional[StrictStr] = Field(default=None, description="Source location")
    chromatography: Optional[StrictStr] = Field(default=None, description="Chromatography the run was measured with, e.g. 'Liquid Chromatography'.")
    ionization: Optional[StrictStr] = Field(default=None, description="Ionization the run was measured with, named as in the HUPO PSI-MS controlled vocabulary,  e.g. 'electrospray ionization'.")
    fragmentation: Optional[StrictStr] = Field(default=None, description="Fragmentation the run was measured with, named as in the HUPO PSI-MS controlled vocabulary,  e.g. 'beam-type collision-induced dissociation'.")
    mass_analyzers: Optional[List[Optional[StrictStr]]] = Field(default=None, description="Mass analyzers of the instrument the run was measured on, named as in the HUPO PSI-MS  controlled vocabulary, e.g. 'orbitrap'.", alias="massAnalyzers")
