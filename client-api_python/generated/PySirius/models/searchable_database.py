...
class SearchableDatabase(BaseModel):
    ...
    match_rt_of_reference_spectra: Optional[StrictBool] = Field(default=None, description="Indicates whether this database shall be used to use retention time information for library matching.  Typically used for in-house spectral libraries that have been measured on", alias="matchRtOfReferenceSpectra")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matchRtOfReferenceSpectra": obj.get("matchRtOfReferenceSpectra"),
