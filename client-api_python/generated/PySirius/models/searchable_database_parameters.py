...
class SearchableDatabaseParameters(BaseModel):
    ...
    """ # noqa: E501
    display_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=15)]] = Field(default=None, description="display name of the database  Should be short", alias="displayName")
