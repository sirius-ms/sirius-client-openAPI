...
class SecurityContext(BaseModel):
    ...
    SecurityContext
    """ # noqa: E501
    principal: Optional[SecurityContextPrincipal] = None
    __properties: ClassVar[List[str]] = ["principal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "principal": SecurityContextPrincipal.from_dict(obj["principal"]) if obj.get("principal") is not None else None
        })
        return _obj
