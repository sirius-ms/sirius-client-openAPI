...
class Sirius(object):
    ...
    def __init__(self, enabled=None, profile=None, number_of_candidates=None, number_of_candidates_per_ion=None, mass_accuracy_ms2ppm=None, isotope_ms2_settings=None, formula_search_dbs=None, enforced_formula_constraints=None, fallback_formula_constraints=None, detectable_elements=None, ilp_timeout=None, use_heuristic=None):  # noqa: E501
        ...
        if formula_search_dbs is not None:
            self.formula_search_dbs = formula_search_dbs
    ...
    @property
    def formula_search_dbs(self):
        """Gets the formula_search_dbs of this Sirius.  # noqa: E501
        ...
        :return: The formula_search_dbs of this Sirius.  # noqa: E501
        :rtype: list[str]
        """
        return self._formula_search_dbs

    @formula_search_dbs.setter
    def formula_search_dbs(self, formula_search_dbs):
        """Sets the formula_search_dbs of this Sirius.

        List Structure database to extract molecular formulas from to reduce formula search space.  SIRIUS is quite good at de novo formula annotation, so only enable if you have a good reason.  # noqa: E501

        :param formula_search_dbs: The formula_search_dbs of this Sirius.  # noqa: E501
        :type: list[str]
        """
        ...
        if not set(formula_search_dbs).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `formula_search_dbs` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(formula_search_dbs) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )

        self._formula_search_dbs = formula_search_dbs
