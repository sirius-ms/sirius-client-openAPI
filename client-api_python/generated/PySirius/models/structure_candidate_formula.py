...
class StructureCandidateFormula(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["inchiKey", "smiles", "structureName", "xlogP", "dbLinks", "refSpectraLinks", "csiScore", "tanimotoSimilarity", "confidenceExactMatch", "confidenceApproxMatch", "fingerprint", "molecularFormula", "adduct", "formulaId"]
