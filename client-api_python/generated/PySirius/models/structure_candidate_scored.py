...
class StructureCandidateScored(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["inchiKey", "smiles", "structureName", "xlogP", "dbLinks", "spectralLibraryMatches", "csiScore", "tanimotoSimilarity", "mcesDistToTopHit", "fingerprint"]
