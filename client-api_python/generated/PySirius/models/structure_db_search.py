...
class StructureDbSearch(object):
    ...
    def structure_search_d_bs(self, structure_search_d_bs):
        ...
        :type: list[str]
        """
        allowed_values = ["ALL", "ALL_BUT_INSILICO", "BIO", "PUBCHEM", "MESH", "HMDB", "KNAPSACK", "CHEBI", "PUBMED", "KEGG", "HSDB", "MACONDA", "METACYC", "GNPS", "ZINCBIO", "TRAIN", "YMDB", "PLANTCYC", "NORMAN", "ADDITIONAL", "SUPERNATURAL", "COCONUT", "BloodExposome", "TeroMol", "PUBCHEMANNOTATIONBIO", "PUBCHEMANNOTATIONDRUG", "PUBCHEMANNOTATIONSAFETYANDTOXIC", "PUBCHEMANNOTATIONFOOD", "LOTUS", "FooDB", "MiMeDB", "LIPIDMAPS", "LIPID", "KEGGMINE", "ECOCYCMINE", "YMDBMINE", "MASSBANK", "DSSTox"]  # noqa: E501
