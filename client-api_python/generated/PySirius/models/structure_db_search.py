...
class StructureDbSearch(object):
    ...
    swagger_types = {
        'enabled': 'bool',
        'structure_search_dbs': 'list[str]',
        'tag_lipids': 'bool'
    }

    attribute_map = {
        'enabled': 'enabled',
        'structure_search_dbs': 'structureSearchDBs',
        'tag_lipids': 'tagLipids'
    }

    def __init__(self, enabled=None, structure_search_dbs=None, tag_lipids=None):  # noqa: E501
        """StructureDbSearch - a model defined in Swagger"""  # noqa: E501
        self._enabled = None
        self._structure_search_dbs = None
        self._tag_lipids = None
        self.discriminator = None
        if enabled is not None:
            self.enabled = enabled
        if structure_search_dbs is not None:
            self.structure_search_dbs = structure_search_dbs
    ...
    @property
    def structure_search_dbs(self):
        """Gets the structure_search_dbs of this StructureDbSearch.  # noqa: E501

        Structure databases to search in  # noqa: E501

        :return: The structure_search_dbs of this StructureDbSearch.  # noqa: E501
        :rtype: list[str]
        """
        return self._structure_search_dbs

    @structure_search_dbs.setter
    def structure_search_dbs(self, structure_search_dbs):
        """Sets the structure_search_dbs of this StructureDbSearch.

        Structure databases to search in  # noqa: E501

        :param structure_search_dbs: The structure_search_dbs of this StructureDbSearch.  # noqa: E501
        :type: list[str]
        """
        ...
        if not set(structure_search_dbs).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `structure_search_dbs` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(structure_search_dbs) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )

        self._structure_search_dbs = structure_search_dbs
