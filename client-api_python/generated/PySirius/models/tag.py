...
class Tag(BaseModel):
    ...
    Tag
    """ # noqa: E501
    tag_name: StrictStr = Field(description="Name of the tag as defined by the corresponding TagDefinition  Links the tag object to its definition.", alias="tagName")
