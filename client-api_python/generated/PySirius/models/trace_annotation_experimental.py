...
class TraceAnnotationExperimental(BaseModel):
    """
    EXPERIMENTAL: This schema is experimental and may be changed (or even removed) without notice until it is declared stable.
    """ # noqa: E501
    type: Optional[TraceAnnotationTypeExperimental] = None
    description: Optional[StrictStr] = None
    index: Optional[StrictInt] = None
    var_from: Optional[StrictInt] = Field(default=None, alias="from")
    to: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["type", "description", "index", "from", "to"]
