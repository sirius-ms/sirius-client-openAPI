...
class WorkerList(BaseModel):
    ...
    WorkerList
    """ # noqa: E501
    pending_jobs: StrictInt = Field(alias="pendingJobs")
    worker_list: List[WorkerInfo] = Field(alias="workerList")
    __properties: ClassVar[List[str]] = ["pendingJobs", "workerList"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in worker_list (list)
        _items = []
        if self.worker_list:
            for _item in self.worker_list:
                if _item:
                    _items.append(_item.to_dict())
            _dict['workerList'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workerList": [WorkerInfo.from_dict(_item) for _item in obj["workerList"]] if obj.get("workerList") is not None else None
        })
        return _obj
