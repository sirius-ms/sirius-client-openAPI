...
class ZodiacEdgeFilterThresholds(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["thresholdFilter", "minLocalCandidates", "minLocalConnections", "identifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "thresholdFilter": obj.get("thresholdFilter"),
            "minLocalCandidates": obj.get("minLocalCandidates"),
            "minLocalConnections": obj.get("minLocalConnections"),
