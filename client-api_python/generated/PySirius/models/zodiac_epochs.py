...
class ZodiacEpochs(BaseModel):
    """
    
    """ # noqa: E501
    iterations: Optional[StrictInt] = None
    burn_in_period: Optional[StrictInt] = Field(default=None, alias="burnInPeriod")
    number_of_markov_chains: Optional[StrictInt] = Field(default=None, alias="numberOfMarkovChains")
    identifier: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["iterations", "burnInPeriod", "numberOfMarkovChains", "identifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "burnInPeriod": obj.get("burnInPeriod"),
            "numberOfMarkovChains": obj.get("numberOfMarkovChains"),
