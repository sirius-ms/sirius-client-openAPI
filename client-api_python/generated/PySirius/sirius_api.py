...
class SiriusAPI:
    ...
    class CompoundsApi:
        ...
        def delete_compound(self, project_id, compound_id):
            return self.api_instance.delete_compound(project_id, compound_id)
        def get_compound(self, project_id, compound_id, top_annotation = False, ms_data = False):
            return self.api_instance.get_compound(project_id, compound_id, top_annotation, ms_data)
        def get_compounds(self, project_id, top_annotation = False, ms_data = False):
            return self.api_instance.get_compound(project_id, top_annotation, ms_data)
        def import_compounds(self, body, project_id, align_lcms_runs = False, allow_ms1_only_data = True, ignore_formulas = False):
            return self.api_instance.import_compounds(body, project_id, align_lcms_runs, allow_ms1_only_data, ignore_formulas)
        def import_compounds_from_string(self, body, data_format, project_id, source_name=None):
    ...
    class ComputationsApi:
        ...
        def delete_job(self, project_id, job_id, cancel_if_running=True, await_deletion=True):
            return self.api_instance.delete_job(project_id, job_id, cancel_if_running, await_deletion)
        def delete_job_config(self, name):
            return self.api_instance.delete_job_config(name)
        def get_default_job_config(self, include_config_map=False):
            return self.api_instance.get_default_job_config(include_config_map)
        def get_job(self, project_id, job_id, include_state=True, include_command=False, include_affected_compounds=False):
            return self.api_instance.get_job(project_id, job_id, include_state, include_command, include_affected_compounds)
        def get_job_config(self, name, include_config_map=False):
            return self.api_instance.get_job_config(name, include_config_map)
        def get_job_configs(self, include_config_map=False):
            return self.api_instance.get_job_configs(include_config_map)
        def get_jobs(self, project_id, include_state=False, include_command=False, include_affected_compounds=False):
        ...
        def post_job_config(self, body, name, override_existing=False):
            return self.api_instance.post_job_config(body, name, override_existing)
        def start_job(self, body, project_id, include_state=True, include_command=True, include_affected_compounds=False):
            return self.api_instance.start_job(body, project_id, include_state, include_command, include_affected_compounds)
        def start_job_from_config(self, body, job_config_name, project_id, recompute=True, include_state=True, include_command=True, include_affected_compounds=False):
    ...
    class FormulaResultsApi:
        ...
        def get_best_matching_canopus_predictions(self, project_id, compound_id, formula_id):
            return self.api_instance.get_best_matching_canopus_predictions(project_id, compound_id, formula_id)
        def get_canopus_predictions(self, project_id, compound_id, formula_id):
            return self.api_instance.get_canopus_predictions(project_id, compound_id, formula_id)
        def get_fingerprint_prediction(self, project_id, compound_id, formula_id):
            return self.api_instance.get_fingerprint_prediction(project_id, compound_id, formula_id)
        def get_formula_ids(self, project_id, compound_id, result_overview=True, formula_candidate=False):
        ...
        def get_formula_result(self, project_id, compound_id, formula_id, result_overview=True, formula_candidate=True):
            return self.api_instance.get_formula_result(project_id, compound_id, formula_id, result_overview, formula_candidate)
        def get_frag_tree(self, project_id, compound_id, formula_id):
            return self.api_instance.get_frag_tree(project_id, compound_id, formula_id)
        def get_simulated_isotope_pattern(self, project_id, compound_id, formula_id):
            return self.api_instance.get_simulated_isotope_pattern(project_id, compound_id, formula_id)
        def get_structure_candidates(self, project_id, compound_id, formula_id, fingerprint=False, db_links=False, pub_med_ids=False, top_k=-1):
        ...
        def get_top_structure_candidate(self, project_id, compound_id, fingerprint=False, db_links=False, pub_med_ids=False):
    ...
    class GraphicalUserInterfaceApi:
        ...
        def apply_to_gui(self, body, project_id):
            return self.api_instance.apply_to_gui(body, project_id)
        def close_gui(self, project_id):
    ...
    class LoginAndAccountApi:
        ...
        def get_account_info(self, include_subs=False):
        ...
        def login(self, body, accept_terms=True, fail_when_logged_in=False, include_subs=False):
    ...
    class ProjectSpacesApi:
        ...
        def close_project_space(self, project_id):
            return self.api_instance.close_project_space(project_id)
        def create_project_space(self, project_id, path_to_project, path_to_source_project=None, await_import=True):
            return self.api_instance.create_project_space(project_id, path_to_project, path_to_source_project, await_import)
        def get_project_space(self, project_id):
            return self.api_instance.get_project_space(project_id)
        def get_project_spaces(self):
            return self.api_instance.get_project_spaces()
        def open_project_space(self, project_id, path_to_project):
