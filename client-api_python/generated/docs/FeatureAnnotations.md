...
**specified_databases** | **List[Optional[str]]** | List of databases that have been specified for structure db search. Null if no structure db search has been performed. | [optional] 
