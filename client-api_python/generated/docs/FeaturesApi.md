...
[**add_tags_to_aligned_features_experimental**](FeaturesApi.md#add_tags_to_aligned_features_experimental) | **PUT** /api/projects/{projectId}/aligned-features/tags | [EXPERIMENTAL] Add tags to a feature (aligned over runs) in the project
...
[**get_aligned_features_page_experimental**](FeaturesApi.md#get_aligned_features_page_experimental) | **GET** /api/projects/{projectId}/aligned-features/page | [EXPERIMENTAL] Get features (aligned over runs) in the given project-space
...
[**get_sirius_frag_tree_internal**](FeaturesApi.md#get_sirius_frag_tree_internal) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas/{formulaId}/sirius-fragtree | [INTERNAL] Returns fragmentation tree (SIRIUS) for the given formula result identifier in SIRIUS&#39; internal format
...
> List[StructureCandidateFormula] add_de_novo_structure_candidate(project_id, aligned_feature_id, smiles=smiles, skip_existence_check=skip_existence_check)
...
with PySirius.ApiClient(configuration) as api_client:
    ...
    skip_existence_check = False # bool | if true, skips a check if this compound is an existing candidate, potentially leading to duplicate structures. (optional) (default to False)

    try:
        # [EXPERIMENTAL] Add molecular structures (as SMILES) to the list of de novo structures.
        api_response = api_instance.add_de_novo_structure_candidate(project_id, aligned_feature_id, smiles=smiles, skip_existence_check=skip_existence_check)
 ...
 **skip_existence_check** | **bool**| if true, skips a check if this compound is an existing candidate, potentially leading to duplicate structures. | [optional] [default to False]
...
with PySirius.ApiClient(configuration) as api_client:
    ...
    aligned_feature_id = 'aligned_feature_id_example' # str | feature to add tags to.
 ...
 **aligned_feature_id** | **str**| feature to add tags to. | 
...
# **add_tags_to_aligned_features_experimental**
> add_tags_to_aligned_features_experimental(project_id, tag_submission)
...
with PySirius.ApiClient(configuration) as api_client:
    ...
    api_instance = PySirius.FeaturesApi(api_client)
    project_id = 'project_id_example' # str | project-space to add to.
    tag_submission = [PySirius.TagSubmission()] # List[TagSubmission] | tags with the id of feature they shall be added to.

    try:
        # [EXPERIMENTAL] Add tags to a feature (aligned over runs) in the project
        api_instance.add_tags_to_aligned_features_experimental(project_id, tag_submission)
    except Exception as e:
        print("Exception when calling FeaturesApi->add_tags_to_aligned_features_experimental: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **project_id** | **str**| project-space to add to. | 
 **tag_submission** | [**List[TagSubmission]**](TagSubmission.md)| tags with the id of feature they shall be added to. | 
...
> PagedModelAlignedFeature get_aligned_features_by_group_experimental(project_id, group_name, page=page, size=size, sort=sort, ms_data_search_prepared=ms_data_search_prepared, opt_fields=opt_fields)
...
with PySirius.ApiClient(configuration) as api_client:
    ...
    try:
        # [EXPERIMENTAL] Get features (aligned over runs) by tag group
        api_response = api_instance.get_aligned_features_by_group_experimental(project_id, group_name, page=page, size=size, sort=sort, ms_data_search_prepared=ms_data_search_prepared, opt_fields=opt_fields)
...
# **get_aligned_features_page_experimental**
> PagedModelAlignedFeature get_aligned_features_page_experimental(project_id, page=page, size=size, sort=sort, search_query=search_query, ms_data_search_prepared=ms_data_search_prepared, opt_fields=opt_fields)
...
with PySirius.ApiClient(configuration) as api_client:
    ...
    try:
        # [EXPERIMENTAL] Get features (aligned over runs) in the given project-space
        api_response = api_instance.get_aligned_features_page_experimental(project_id, page=page, size=size, sort=sort, search_query=search_query, ms_data_search_prepared=ms_data_search_prepared, opt_fields=opt_fields)
        print("The response of FeaturesApi->get_aligned_features_page_experimental:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FeaturesApi->get_aligned_features_page_experimental: %s\n" % e)
```
...
# **get_sirius_frag_tree_internal**
> str get_sirius_frag_tree_internal(project_id, aligned_feature_id, formula_id)
...
with PySirius.ApiClient(configuration) as api_client:
    ...
    try:
        # [INTERNAL] Returns fragmentation tree (SIRIUS) for the given formula result identifier in SIRIUS' internal format
        api_response = api_instance.get_sirius_frag_tree_internal(project_id, aligned_feature_id, formula_id)
        print("The response of FeaturesApi->get_sirius_frag_tree_internal:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FeaturesApi->get_sirius_frag_tree_internal: %s\n" % e)
```
