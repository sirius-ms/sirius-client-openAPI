...
**affected_compound_ids** | **List[Optional[str]]** | List of compoundIds that are affected by this job.  This list will also contain compoundIds where not all features of the compound are affected by the job.  If this job is creating compounds (e.g. data import jobs) this value will be NULL until the job has finished | [optional] 
**affected_aligned_feature_ids** | **List[Optional[str]]** | List of alignedFeatureIds that are affected by this job.  If this job is creating features (e.g. data import jobs) this value will be NULL until the job has finished | [optional] 
