...
class TestAlignedFeature(unittest.TestCase):
    """AlignedFeature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlignedFeature:
        """Test AlignedFeature
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlignedFeature`
        """
        model = AlignedFeature()
        if include_optional:
