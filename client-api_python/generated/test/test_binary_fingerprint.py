...
class TestBinaryFingerprint(unittest.TestCase):
    """BinaryFingerprint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BinaryFingerprint:
        """Test BinaryFingerprint
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BinaryFingerprint`
        """
        model = BinaryFingerprint()
        if include_optional:
    ...
    def testBinaryFingerprint(self):
        """Test BinaryFingerprint"""
