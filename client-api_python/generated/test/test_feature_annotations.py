...
class TestFeatureAnnotations(unittest.TestCase):
    """FeatureAnnotations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureAnnotations:
        """Test FeatureAnnotations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureAnnotations`
        """
        model = FeatureAnnotations()
        if include_optional:
    ...
    def testFeatureAnnotations(self):
        """Test FeatureAnnotations"""
