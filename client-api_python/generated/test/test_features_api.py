...
class TestFeaturesApi(unittest.TestCase):
    ...
    def test_get_aligned_features_page(self) -> None:
        """Test case for get_aligned_features_page

        Get all available features (aligned over runs) in the given project-space.
        """
        response = self.api.features().get_aligned_features_page(self.project_id)
    ...
    def test_get_de_novo_structure_candidates_by_formula_page(self) -> None:
        """Test case for get_de_novo_structure_candidates_by_formula_page
        ...
        """
        response = self.api.features().get_de_novo_structure_candidates_by_formula_page(self.project_id,
                                                                                         self.aligned_feature_id,
                                                                                         self.formula_id)
        self.assertIsInstance(response, PagedModelStructureCandidateScored)

    def test_get_de_novo_structure_candidates_page(self) -> None:
        """Test case for get_de_novo_structure_candidates_page
        ...
        """
        response = self.api.features().get_de_novo_structure_candidates_page(self.project_id, self.aligned_feature_id)
    ...
    def test_get_formula_candidates_page(self) -> None:
        """Test case for get_formula_candidates_page

        Page of FormulaResultContainers available for this feature with minimal information.
        """
        response = self.api.features().get_formula_candidates_page(self.project_id, self.aligned_feature_id)
    ...
    def test_get_spectral_library_matches_page(self) -> None:
        """Test case for get_spectral_library_matches_page

        Page of spectral library matches for the given 'alignedFeatureId'.
        """
        response = self.api.features().get_spectral_library_matches_page(self.project_id, self.aligned_feature_id)
    ...
    def test_get_structure_candidates_by_formula_page(self) -> None:
        """Test case for get_structure_candidates_by_formula_page

        Page of CSI:FingerID structure database search candidates for the given 'formulaId' with minimal information.
        """
        response = self.api.features().get_structure_candidates_by_formula_page(self.project_id,
                                                                                 self.aligned_feature_id,
                                                                                 self.formula_id)
        self.assertIsInstance(response, PagedModelStructureCandidateScored)

    def test_get_structure_candidates_page(self) -> None:
        """Test case for get_structure_candidates_page
        ...
        """
        response = self.api.features().get_structure_candidates_page(self.project_id, self.aligned_feature_id)
        self.assertIsInstance(response, PagedModelStructureCandidateFormula)


    def test_get_aligned_features_paged_deprecated_alias(self) -> None:
