...
class TestStructureCandidateScored(unittest.TestCase):
    """StructureCandidateScored unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StructureCandidateScored:
        """Test StructureCandidateScored
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StructureCandidateScored`
        """
        model = StructureCandidateScored()
        if include_optional:
            return StructureCandidateScored(
                inchi_key = '',
                smiles = '',
                structure_name = '',
                xlog_p = 1.337,
    ...
    def testStructureCandidateScored(self):
        """Test StructureCandidateScored"""
