...
class TestZodiacNumberOfConsideredCandidatesAt300Mz(unittest.TestCase):
    """ZodiacNumberOfConsideredCandidatesAt300Mz unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZodiacNumberOfConsideredCandidatesAt300Mz:
        """Test ZodiacNumberOfConsideredCandidatesAt300Mz
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZodiacNumberOfConsideredCandidatesAt300Mz`
        """
        model = ZodiacNumberOfConsideredCandidatesAt300Mz()
        if include_optional:
