...
SiriusApi = R6::R6Class(
  ...
  public = list(
    ...
    get_CompoundsApi = function(){
      return(CompoundsApi$new())
    },
    # create ComputationsApi subclass
    get_ComputationsApi = function(){
      return(ComputationsApi$new())
    },
    # create FormulaResultsApi subclass    
    get_FormulaResultsApi = function(){
      return(FormulaResultsApi$new())
    },
    # create FormulaResultsApi subclass    
    get_GraphicalUserInterfaceApi = function(){
      return(GraphicalUserInterfaceApi$new())
    },
    # create LoginAndAccountApi subclass    
    get_LoginAndAccountApi = function(){
      return(LoginAndAccountApi$new())
    },
    # create ProjectSpacesApi subclass    
    get_ProjectSpacesApi = function(){
      return(ProjectSpacesApi$new())
    },
    # create VersionInfoControllerApi subclass    
    get_VersionInfoControllerApi = function(){
      return(VersionInfoControllerApi$new())
    },
    # create VersionInfoControllerApi subclass    
    get_Models = function(){
      return(Models$new())
