...
CompoundStatisticsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return Job
    ComputeCompoundFoldChangesExperimental = function(project_id, left_group_name, right_group_name, aggregation = "AVG", quantification = "APEX_INTENSITY", opt_fields = [progress], data_file = NULL, ...) {
    ...
    ComputeCompoundFoldChangesExperimentalWithHttpInfo = function(project_id, left_group_name, right_group_name, aggregation = "AVG", quantification = "APEX_INTENSITY", opt_fields = [progress], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
