  ...
  public = list(
    ...
    ComputeCompoundFoldChangesExperimentalWithHttpInfo = function(project_id, left_group_name, right_group_name, aggregation = "AVG", quantification = "APEX_INTENSITY", opt_fields = list(progress), data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling CompoundStatisticsApi$ComputeCompoundFoldChangesExperimental, `project_id` is not nullable")
      }

      if (!missing(`left_group_name`) && is.null(`left_group_name`)) {
        stop("Invalid value for `left_group_name` when calling CompoundStatisticsApi$ComputeCompoundFoldChangesExperimental, `left_group_name` is not nullable")
      }

      if (!missing(`right_group_name`) && is.null(`right_group_name`)) {
        stop("Invalid value for `right_group_name` when calling CompoundStatisticsApi$ComputeCompoundFoldChangesExperimental, `right_group_name` is not nullable")
      }

      if (!missing(`aggregation`) && is.null(`aggregation`)) {
        stop("Invalid value for `aggregation` when calling CompoundStatisticsApi$ComputeCompoundFoldChangesExperimental, `aggregation` is not nullable")
      }

      if (!missing(`quantification`) && is.null(`quantification`)) {
        stop("Invalid value for `quantification` when calling CompoundStatisticsApi$ComputeCompoundFoldChangesExperimental, `quantification` is not nullable")
      }

      if (!missing(`opt_fields`) && is.null(`opt_fields`)) {
        stop("Invalid value for `opt_fields` when calling CompoundStatisticsApi$ComputeCompoundFoldChangesExperimental, `opt_fields` is not nullable")
      }
    ...
    DeleteCompoundFoldChangesExperimentalWithHttpInfo = function(project_id, left_group_name, right_group_name, aggregation = "AVG", quantification = "APEX_INTENSITY", ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling CompoundStatisticsApi$DeleteCompoundFoldChangesExperimental, `project_id` is not nullable")
      }

      if (!missing(`left_group_name`) && is.null(`left_group_name`)) {
        stop("Invalid value for `left_group_name` when calling CompoundStatisticsApi$DeleteCompoundFoldChangesExperimental, `left_group_name` is not nullable")
      }

      if (!missing(`right_group_name`) && is.null(`right_group_name`)) {
        stop("Invalid value for `right_group_name` when calling CompoundStatisticsApi$DeleteCompoundFoldChangesExperimental, `right_group_name` is not nullable")
      }

      if (!missing(`aggregation`) && is.null(`aggregation`)) {
        stop("Invalid value for `aggregation` when calling CompoundStatisticsApi$DeleteCompoundFoldChangesExperimental, `aggregation` is not nullable")
      }

      if (!missing(`quantification`) && is.null(`quantification`)) {
        stop("Invalid value for `quantification` when calling CompoundStatisticsApi$DeleteCompoundFoldChangesExperimental, `quantification` is not nullable")
      }
    ...
    GetCompoundFoldChangeTableExperimentalWithHttpInfo = function(project_id, aggregation = "AVG", quantification = "APEX_INTENSITY", data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling CompoundStatisticsApi$GetCompoundFoldChangeTableExperimental, `project_id` is not nullable")
      }

      if (!missing(`aggregation`) && is.null(`aggregation`)) {
        stop("Invalid value for `aggregation` when calling CompoundStatisticsApi$GetCompoundFoldChangeTableExperimental, `aggregation` is not nullable")
      }

      if (!missing(`quantification`) && is.null(`quantification`)) {
        stop("Invalid value for `quantification` when calling CompoundStatisticsApi$GetCompoundFoldChangeTableExperimental, `quantification` is not nullable")
      }
    ...
    GetFoldChangesByCompoundExperimentalWithHttpInfo = function(project_id, object_id, data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling CompoundStatisticsApi$GetFoldChangesByCompoundExperimental, `project_id` is not nullable")
      }

      if (!missing(`object_id`) && is.null(`object_id`)) {
        stop("Invalid value for `object_id` when calling CompoundStatisticsApi$GetFoldChangesByCompoundExperimental, `object_id` is not nullable")
      }
