...
CompoundStatisticsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return Job
    ComputeCompoundFoldChangesExperimental = function(project_id, fold_change_job_submission, opt_fields = list("progress"), data_file = NULL, ...) {
      local_var_response <- self$ComputeCompoundFoldChangesExperimentalWithHttpInfo(project_id, fold_change_job_submission, opt_fields, data_file = data_file, ...)
    ...
    ComputeCompoundFoldChangesExperimentalWithHttpInfo = function(project_id, fold_change_job_submission, opt_fields = list("progress"), data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
