...
CompoundsApi <- R6::R6Class(
  ...
  public = list(
    ...
    AddCompounds = function(project_id, compound_import, profile = NULL, opt_fields = [none], opt_fields_features = [none], data_file = NULL, ...) {
    ...
    AddCompoundsWithHttpInfo = function(project_id, compound_import, profile = NULL, opt_fields = [none], opt_fields_features = [none], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return Compound
    GetCompound = function(project_id, compound_id, ms_data_search_prepared = FALSE, opt_fields = [none], opt_fields_features = [none], data_file = NULL, ...) {
    ...
    GetCompoundWithHttpInfo = function(project_id, compound_id, ms_data_search_prepared = FALSE, opt_fields = [none], opt_fields_features = [none], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    GetCompoundsByGroupExperimental = function(project_id, group_name, page = 0, size = 20, sort = NULL, opt_fields = [none], data_file = NULL, ...) {
    ...
    GetCompoundsByGroupExperimentalWithHttpInfo = function(project_id, group_name, page = 0, size = 20, sort = NULL, opt_fields = [none], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return PagedModelCompound
    GetCompoundsPaged = function(project_id, page = 0, size = 20, sort = NULL, ms_data_search_prepared = FALSE, opt_fields = [none], opt_fields_features = [none], data_file = NULL, ...) {
    ...
    #'
    #' @return API response (PagedModelCompound) with additional information such as HTTP status code, headers
    GetCompoundsPagedWithHttpInfo = function(project_id, page = 0, size = 20, sort = NULL, ms_data_search_prepared = FALSE, opt_fields = [none], opt_fields_features = [none], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
