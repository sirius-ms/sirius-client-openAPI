...
CompoundsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param lcms_feature_quality (optional) No description (default value: FALSE)
    #' @param ms_quality (optional) No description (default value: FALSE)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return CompoundId
    #' @export
    GetCompound = function(project_id, cid, top_annotation = FALSE, ms_data = FALSE, lcms_feature_quality = FALSE, ms_quality = FALSE, data_file = NULL, ...) {
      local_var_response <- self$GetCompoundWithHttpInfo(project_id, cid, top_annotation, ms_data, lcms_feature_quality, ms_quality, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    GetCompoundWithHttpInfo = function(project_id, cid, top_annotation = FALSE, ms_data = FALSE, lcms_feature_quality = FALSE, ms_quality = FALSE, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      query_params[["lcmsFeatureQuality"]] <- `lcms_feature_quality`
    ...
    #' @export
    GetCompounds = function(project_id, top_annotation = FALSE, ms_data = FALSE, lcms_feature_quality = FALSE, ms_quality = FALSE, data_file = NULL, ...) {
      local_var_response <- self$GetCompoundsWithHttpInfo(project_id, top_annotation, ms_data, lcms_feature_quality, ms_quality, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @export
    GetCompoundsWithHttpInfo = function(project_id, top_annotation = FALSE, ms_data = FALSE, lcms_feature_quality = FALSE, ms_quality = FALSE, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
