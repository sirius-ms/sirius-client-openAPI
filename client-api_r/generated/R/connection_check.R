...
ConnectionCheck <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`licenseInfo`, `errors`, `supportsNegPredictorTypes`, `availableWorkers`, `supportsPosPredictorTypes`, `unAvailableWorkers`, `supportsAllPredictorTypes`, `workerInfo` = NULL, ...) {
