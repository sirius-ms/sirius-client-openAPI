...
ConnectionCheck <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`licenseInfo`, `errors`, `availableWorkers`, `unAvailableWorkers`, `supportsAllPredictorTypes`, `supportsPosPredictorTypes`, `supportsNegPredictorTypes`, `workerInfo` = NULL, ...) {
