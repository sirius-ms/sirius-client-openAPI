...
#' @field specifiedDatabases List of databases that have been specified for structure db search. Null if no structure db search has been performed. list(character) [optional]
...
FeatureAnnotations <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param specifiedDatabases List of databases that have been specified for structure db search. Null if no structure db search has been performed.
