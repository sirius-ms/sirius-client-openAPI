  ...
  public = list(
    ...
    ComputeAlignedFeatureFoldChangesExperimentalWithHttpInfo = function(project_id, left_group_name, right_group_name, aggregation = "AVG", quantification = "APEX_INTENSITY", opt_fields = list(progress), data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling FeatureStatisticsApi$ComputeAlignedFeatureFoldChangesExperimental, `project_id` is not nullable")
      }

      if (!missing(`left_group_name`) && is.null(`left_group_name`)) {
        stop("Invalid value for `left_group_name` when calling FeatureStatisticsApi$ComputeAlignedFeatureFoldChangesExperimental, `left_group_name` is not nullable")
      }

      if (!missing(`right_group_name`) && is.null(`right_group_name`)) {
        stop("Invalid value for `right_group_name` when calling FeatureStatisticsApi$ComputeAlignedFeatureFoldChangesExperimental, `right_group_name` is not nullable")
      }

      if (!missing(`aggregation`) && is.null(`aggregation`)) {
        stop("Invalid value for `aggregation` when calling FeatureStatisticsApi$ComputeAlignedFeatureFoldChangesExperimental, `aggregation` is not nullable")
      }

      if (!missing(`quantification`) && is.null(`quantification`)) {
        stop("Invalid value for `quantification` when calling FeatureStatisticsApi$ComputeAlignedFeatureFoldChangesExperimental, `quantification` is not nullable")
      }

      if (!missing(`opt_fields`) && is.null(`opt_fields`)) {
        stop("Invalid value for `opt_fields` when calling FeatureStatisticsApi$ComputeAlignedFeatureFoldChangesExperimental, `opt_fields` is not nullable")
      }
    ...
    DeleteAlignedFeatureFoldChangesExperimentalWithHttpInfo = function(project_id, left_group_name, right_group_name, aggregation = "AVG", quantification = "APEX_INTENSITY", ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling FeatureStatisticsApi$DeleteAlignedFeatureFoldChangesExperimental, `project_id` is not nullable")
      }

      if (!missing(`left_group_name`) && is.null(`left_group_name`)) {
        stop("Invalid value for `left_group_name` when calling FeatureStatisticsApi$DeleteAlignedFeatureFoldChangesExperimental, `left_group_name` is not nullable")
      }

      if (!missing(`right_group_name`) && is.null(`right_group_name`)) {
        stop("Invalid value for `right_group_name` when calling FeatureStatisticsApi$DeleteAlignedFeatureFoldChangesExperimental, `right_group_name` is not nullable")
      }

      if (!missing(`aggregation`) && is.null(`aggregation`)) {
        stop("Invalid value for `aggregation` when calling FeatureStatisticsApi$DeleteAlignedFeatureFoldChangesExperimental, `aggregation` is not nullable")
      }

      if (!missing(`quantification`) && is.null(`quantification`)) {
        stop("Invalid value for `quantification` when calling FeatureStatisticsApi$DeleteAlignedFeatureFoldChangesExperimental, `quantification` is not nullable")
      }
    ...
    GetAlignedFeatureFoldChangeTableExperimentalWithHttpInfo = function(project_id, aggregation = "AVG", quantification = "APEX_INTENSITY", data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling FeatureStatisticsApi$GetAlignedFeatureFoldChangeTableExperimental, `project_id` is not nullable")
      }

      if (!missing(`aggregation`) && is.null(`aggregation`)) {
        stop("Invalid value for `aggregation` when calling FeatureStatisticsApi$GetAlignedFeatureFoldChangeTableExperimental, `aggregation` is not nullable")
      }

      if (!missing(`quantification`) && is.null(`quantification`)) {
        stop("Invalid value for `quantification` when calling FeatureStatisticsApi$GetAlignedFeatureFoldChangeTableExperimental, `quantification` is not nullable")
      }
    ...
    GetFoldChangesByAlignedFeatureExperimentalWithHttpInfo = function(project_id, object_id, data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling FeatureStatisticsApi$GetFoldChangesByAlignedFeatureExperimental, `project_id` is not nullable")
      }

      if (!missing(`object_id`) && is.null(`object_id`)) {
        stop("Invalid value for `object_id` when calling FeatureStatisticsApi$GetFoldChangesByAlignedFeatureExperimental, `object_id` is not nullable")
      }
