...
#' \item \emph{ @param } opt_fields Enum < [none, msData, topAnnotations, topAnnotationsDeNovo, computedTools] >
...
#' }
#'
#' \strong{ GetAdductNetworkWithMergedTracesExperimental } \emph{ EXPERIMENTAL: This endpoint is experimental and may be changed (or even removed) without notice until it is declared stable. }
...
#' \item \emph{ @param } opt_fields Enum < [none, msData, topAnnotations, topAnnotationsDeNovo, computedTools] >
#' \item \emph{ @returnType } \link{PagedModelAlignedFeature} \cr
#'
#'
#' \item status code : 200 | AlignedFeatures with additional annotations and MS/MS data (if specified).
#'
#' \item return type : PagedModelAlignedFeature
#' \item response headers :
#'
#' \tabular{ll}{
#' }
#' }
#'
#' \strong{ GetAlignedFeaturesQualityExperimental } \emph{ EXPERIMENTAL: This endpoint is experimental and may be changed (or even removed) without notice until it is declared stable. }
#' Get data quality information for feature (aligned over runs) with the given identifier from the specified project-space.
#'
#' \itemize{
#' \item \emph{ @param } project_id character
#' \item \emph{ @param } aligned_feature_id character
#' \item \emph{ @returnType } \link{AlignedFeatureQualityExperimental} \cr
#'
#'
#' \item status code : 200 | AlignedFeatureQuality quality information of the respective feature.
#'
#' \item return type : AlignedFeatureQualityExperimental
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' \item \emph{ @param } project_id character
#' \item \emph{ @param } aligned_feature_id character
#' \item \emph{ @param } opt_fields Enum < [none, fingerprint, dbLinks, libraryMatches] >
...
#' \item \emph{ @param } sort list( character )
#' \item \emph{ @param } opt_fields Enum < [none, fingerprint, dbLinks, libraryMatches] >
#' \item \emph{ @returnType } \link{PagedModelStructureCandidateScored} \cr
#'
#'
#' \item status code : 200 | StructureCandidate of this formula candidate with specified optional fields.
#'
#' \item return type : PagedModelStructureCandidateScored
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' \item \emph{ @param } sort list( character )
#' \item \emph{ @param } opt_fields Enum < [none, fingerprint, dbLinks, libraryMatches] >
#' \item \emph{ @returnType } \link{PagedModelStructureCandidateFormula} \cr
#'
#'
#' \item status code : 200 | StructureCandidate of this feature (aligned over runs) candidate with specified optional fields.
#'
#' \item return type : PagedModelStructureCandidateFormula
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' \item \emph{ @param } aligned_feature_id character
#' \item \emph{ @param } formula_id character
#' \item \emph{ @param } opt_fields Enum < [none, statistics, fragmentationTree, annotatedSpectrum, isotopePattern, lipidAnnotation, predictedFingerprint, compoundClasses, canopusPredictions] >
...
#' \item \emph{ @param } sort list( character )
#' \item \emph{ @param } opt_fields Enum < [none, statistics, fragmentationTree, annotatedSpectrum, isotopePattern, lipidAnnotation, predictedFingerprint, compoundClasses, canopusPredictions] >
#' \item \emph{ @returnType } \link{PagedModelFormulaCandidate} \cr
#'
#'
#' \item status code : 200 | All FormulaCandidate of this feature with.
#'
#' \item return type : PagedModelFormulaCandidate
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ GetQuantificationExperimental } \emph{ EXPERIMENTAL: This endpoint is experimental and may be changed (or even removed) without notice until it is declared stable. }
...
#' \item \emph{ @returnType } \link{QuantificationTableExperimental} \cr
#'
#'
#' \item status code : 200 | Quant table row for this feature
#'
#' \item return type : QuantificationTableExperimental
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' \item \emph{ @param } opt_fields Enum < [none, referenceSpectrum] >
...
#' \item \emph{ @param } inchi_key character
#' \item \emph{ @param } opt_fields Enum < [none, referenceSpectrum] >
#' \item \emph{ @returnType } \link{PagedModelSpectralLibraryMatch} \cr
#'
#'
#' \item status code : 200 | Spectral library matches of this feature (aligned over runs).
#'
#' \item return type : PagedModelSpectralLibraryMatch
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' }
#'
#' \strong{ GetStructureAnnotatedMsDataExperimental } \emph{ EXPERIMENTAL: This endpoint is experimental because it produces return values that are not yet stable. }
...
#' }
#'
#' \strong{ GetStructureAnnotatedSpectrumExperimental } \emph{ EXPERIMENTAL: This endpoint is experimental because it produces return values that are not yet stable. }
#' Returns a fragmentation spectrum (e.g. Merged MS/MS) which is annotated with fragments and losses for the given formula result identifier  These annotations are only available if a fragmentation tree is available.
#'
#' \itemize{
#' \item \emph{ @param } project_id character
...
#' }
#'
#' \strong{ GetTracesExperimental } \emph{ EXPERIMENTAL: This endpoint is experimental and may be changed (or even removed) without notice until it is declared stable. }
...
#'
#'
#' \item status code : 200 | Traces of the given feature.
#'
#' \item return type : TraceSetExperimental
#' \item response headers :
#'
...
FeaturesApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetDeNovoStructureCandidatesWithHttpInfo = function(project_id, aligned_feature_id, opt_fields = list(), data_file = NULL, ...) {
      ...
      for (query_item in `opt_fields`) {
        # validate enum values
        if (!(query_item %in% c("none", "fingerprint", "dbLinks", "libraryMatches"))) {
    ...
    GetFormulaCandidateWithHttpInfo = function(project_id, aligned_feature_id, formula_id, opt_fields = list(), data_file = NULL, ...) {
      ...
      for (query_item in `opt_fields`) {
        # validate enum values
        if (!(query_item %in% c("none", "statistics", "fragmentationTree", "annotatedSpectrum", "isotopePattern", "lipidAnnotation", "predictedFingerprint", "compoundClasses", "canopusPredictions"))) {
    ...
    GetSpectralLibraryMatchWithHttpInfo = function(project_id, aligned_feature_id, match_id, opt_fields = list(), data_file = NULL, ...) {
      ...
      for (query_item in `opt_fields`) {
        # validate enum values
        if (!(query_item %in% c("none", "referenceSpectrum"))) {
    ...
    #' @export
    GetSpectralLibraryMatches = function(project_id, aligned_feature_id, min_shared_peaks = 1, min_similarity = 0.2, inchi_key = "", opt_fields = list(), data_file = NULL, ...) {
    ...
    #' @export
    GetSpectralLibraryMatchesWithHttpInfo = function(project_id, aligned_feature_id, min_shared_peaks = 1, min_similarity = 0.2, inchi_key = "", opt_fields = list(), data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @export
    GetSpectralLibraryMatchesPaged = function(project_id, aligned_feature_id, page = 0, size = 20, sort = NULL, min_shared_peaks = 1, min_similarity = 0.2, inchi_key = "", opt_fields = list(), data_file = NULL, ...) {
    ...
    #' @export
    GetSpectralLibraryMatchesPagedWithHttpInfo = function(project_id, aligned_feature_id, page = 0, size = 20, sort = NULL, min_shared_peaks = 1, min_similarity = 0.2, inchi_key = "", opt_fields = list(), data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
