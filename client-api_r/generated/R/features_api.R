...
#' @section Methods:
#' \describe{
#' \strong{ AddAlignedFeatures } \emph{  }
#'
#' \itemize{
...
#' }
#'
#' \strong{ GetStructureCandidates } \emph{ List of StructureCandidates for the given &#39;alignedFeatureId&#39; with minimal information. }
...
#' }
#'
#' \strong{ GetStructureCandidatesByFormula } \emph{ List of StructureCandidates the given &#39;formulaId&#39; with minimal information. }
...
FeaturesApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetFragTreeWithHttpInfo = function(project_id, aligned_feature_id, formula_id, data_file = NULL, ...) {
      ...
      local_var_url_path <- "/api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas/{formulaId}/tree"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
    ...
    GetSiriusFragTreeWithHttpInfo = function(project_id, aligned_feature_id, formula_id, data_file = NULL, ...) {
      ...
      local_var_url_path <- "/api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas/{formulaId}/sirius-tree"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
    ...
    GetStructureCandidatesWithHttpInfo = function(project_id, aligned_feature_id, page = 0, size = 20, sort = NULL, search_query = NULL, query_syntax = NULL, opt_fields = [], data_file = NULL, ...) {
      ...
      local_var_url_path <- "/api/projects/{projectId}/aligned-features/{alignedFeatureId}/structures"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
    ...
    GetStructureCandidatesByFormulaWithHttpInfo = function(project_id, aligned_feature_id, formula_id, page = 0, size = 20, sort = NULL, search_query = NULL, query_syntax = NULL, opt_fields = [], data_file = NULL, ...) {
      ...
      local_var_url_path <- "/api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas/{formulaId}/structures"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
