...
#'
#' @docType class
#' @title GuiAdvanced operations
#' @description GuiAdvancedApi
...
#' @export
GuiAdvancedApi <- R6::R6Class(
  "GuiAdvancedApi",
  public = list(
    api_client = NULL,
    #' Initialize a new GuiAdvancedApi.
    #'
    #' @description
    #' Initialize a new GuiAdvancedApi.
    #'
    ...
    #' @param read_only (optional) open in read-only mode. (default value: FALSE)
    #' @param gui_parameters (optional) No description
    #' @param ... Other optional arguments
    #' @return void
    #' @export
    OpenGui = function(project_id, read_only = FALSE, gui_parameters = NULL, ...) {
    ...
    #' @return API response (void) with additional information such as HTTP status code, headers
    #' @export
    OpenGuiWithHttpInfo = function(project_id, read_only = FALSE, gui_parameters = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
