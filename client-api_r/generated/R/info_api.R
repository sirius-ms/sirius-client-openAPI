...
InfoApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetConnectionCheckWithHttpInfo = function(data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "ConnectionCheck"),
          error = function(e) {
    ...
    GetInfoWithHttpInfo = function(server_info = TRUE, update_info = TRUE, data_file = NULL, ...) {
      ...
      if (!missing(`server_info`) && is.null(`server_info`)) {
        stop("Invalid value for `server_info` when calling InfoApi$GetInfo, `server_info` is not nullable")
      }

      if (!missing(`update_info`) && is.null(`update_info`)) {
        stop("Invalid value for `update_info` when calling InfoApi$GetInfo, `update_info` is not nullable")
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "Info"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
