...
#' }
#'
#' \strong{ StartImportFromPathJob } \emph{ Import ms/ms data in given format from local filesystem into the specified project }
...
#' \itemize{
#' \item \emph{ @param } project_id character
#' \item \emph{ @param } import_local_files_submission \link{ImportLocalFilesSubmission}
#' \item \emph{ @param } opt_fields list( \link{JobOptField} )
#' \item \emph{ @returnType } \link{Job} \cr
#'
#'
#' \item status code : 200 | JobId of background job that imports given run/compounds/features.
#'
#' \item return type : Job
#' \item response headers :
#'
...
#' }
#'
#' \strong{ StartImportFromStringJob } \emph{ Import ms/ms data from the given format into the specified project-space  Possible formats (ms, mgf, cef, msp, mzML, mzXML) }
#' Import ms/ms data from the given format into the specified project-space  Possible formats (ms, mgf, cef, msp, mzML, mzXML)
#'
#' \itemize{
#' \item \emph{ @param } project_id character
#' \item \emph{ @param } import_string_submission \link{ImportStringSubmission}
#' \item \emph{ @param } opt_fields list( \link{JobOptField} )
#' \item \emph{ @returnType } \link{Job} \cr
#'
#'
...
JobsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param import_local_files_submission configuration of the job that will be submitted
    ...
    #' @return Job
    #' @export
    StartImportFromPathJob = function(project_id, import_local_files_submission, opt_fields = ["command","progress"], data_file = NULL, ...) {
      local_var_response <- self$StartImportFromPathJobWithHttpInfo(project_id, import_local_files_submission, opt_fields, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Job) with additional information such as HTTP status code, headers
    #' @export
    StartImportFromPathJobWithHttpInfo = function(project_id, import_local_files_submission, opt_fields = ["command","progress"], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`import_local_files_submission`)) {
        stop("Missing required parameter `import_local_files_submission`.")
      }
      ...
      if (!is.null(`import_local_files_submission`)) {
        local_var_body <- `import_local_files_submission`$toJSONString()
      } else {
        body <- NULL
      }

      local_var_url_path <- "/api/{projectId}/jobs/import-from-local-path"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
    ...
    #'
    #' @param project_id project-space to import into.
    #' @param import_string_submission configuration of the job that will be submitted
    #' @param opt_fields (optional) set of optional fields to be included. Use 'none' only to override defaults. (default value: ["progress"])
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return Job
    #' @export
    StartImportFromStringJob = function(project_id, import_string_submission, opt_fields = ["progress"], data_file = NULL, ...) {
      local_var_response <- self$StartImportFromStringJobWithHttpInfo(project_id, import_string_submission, opt_fields, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Job) with additional information such as HTTP status code, headers
    #' @export
    StartImportFromStringJobWithHttpInfo = function(project_id, import_string_submission, opt_fields = ["progress"], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`import_string_submission`)) {
        stop("Missing required parameter `import_string_submission`.")
      }
      ...
      if (!is.null(`import_string_submission`)) {
        local_var_body <- `import_string_submission`$toJSONString()
      } else {
        body <- NULL
      }

      local_var_url_path <- "/api/{projectId}/jobs/import-from-string"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
