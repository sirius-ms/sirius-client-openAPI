...
JobsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetJobsPaged = function(project_id, page = 0, size = 20, sort = NULL, opt_fields = [none], data_file = NULL, ...) {
    ...
    GetJobsPagedWithHttpInfo = function(project_id, page = 0, size = 20, sort = NULL, opt_fields = [none], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
