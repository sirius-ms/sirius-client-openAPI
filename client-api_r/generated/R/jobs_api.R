...
#' \item \emph{ @param } move_parameters_to_config_map character
#' \item \emph{ @param } include_custom_dbs_for_structure_search character
...
#' }
#'
#' \strong{ GetJobConfigNames } \emph{ Get all (non-default) job configuration names }
...
#' \item \emph{ @param } opt_fields Enum < [none, command, progress, affectedIds] >
#' \item \emph{ @returnType } \link{PagedModelJob} \cr
#'
#'
#' \item status code : 200 | OK
#'
#' \item return type : PagedModelJob
#' \item response headers :
#'
#' \tabular{ll}{
#' }
