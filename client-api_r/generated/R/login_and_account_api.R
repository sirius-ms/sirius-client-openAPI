...
LoginAndAccountApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' Get information about the account currently logged in.
    #'
    #' @param include_subs (optional) include available and active subscriptions in <code>AccountInfo</code>. (default value: FALSE)
    ...
    GetSignUpURLWithHttpInfo = function(data_file = NULL, ...) {
      ...
      # The Accept request HTTP header
      local_var_accepts <- list("text/plain;charset=UTF-8", "application/problem+json")
