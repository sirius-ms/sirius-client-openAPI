...
#'
#' @docType class
#' @title NPCClassStatistics operations
#' @description NPCClassStatisticsApi
...
#' @export
NPCClassStatisticsApi <- R6::R6Class(
  "NPCClassStatisticsApi",
  public = list(
    api_client = NULL,

    #' @description
    #' Initialize a new NPCClassStatisticsApi.
    #'
    ...
    #'
    #' @return Job
    ComputeNpcClassFoldChangesExperimental = function(project_id, fold_change_job_submission, opt_fields = list("progress"), data_file = NULL, ...) {
      local_var_response <- self$ComputeNpcClassFoldChangesExperimentalWithHttpInfo(project_id, fold_change_job_submission, opt_fields, data_file = data_file, ...)
    ...
    ComputeNpcClassFoldChangesExperimentalWithHttpInfo = function(project_id, fold_change_job_submission, opt_fields = list("progress"), data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      for (query_item in `opt_fields`) {
        ...
        if (!is.null(query_item) && !(query_item %in% c("none", "command", "progress", "affectedIds"))) {
          stop("Invalid value for opt_fields when calling NPCClassStatisticsApi$ComputeNpcClassFoldChangesExperimental. Must be [none, command, progress, affectedIds].")
        }
      ...
      local_var_url_path <- "/api/projects/{projectId}/npc-classes/statistics/foldchange/compute"
      if (!missing(`project_id`)) {
    ...
    #'
    #' @return void
    DeleteNpcClassFoldChangesExperimental = function(project_id, left_group_name, right_group_name, aggregation = "AVG", quantification = "APEX_INTENSITY", ...) {
      local_var_response <- self$DeleteNpcClassFoldChangesExperimentalWithHttpInfo(project_id, left_group_name, right_group_name, aggregation, quantification, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    DeleteNpcClassFoldChangesExperimentalWithHttpInfo = function(project_id, left_group_name, right_group_name, aggregation = "AVG", quantification = "APEX_INTENSITY", ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`aggregation`) && !(`aggregation` %in% c("AVG", "MIN", "MAX"))) {
        stop("Invalid value for aggregation when calling NPCClassStatisticsApi$DeleteNpcClassFoldChangesExperimental. Must be [AVG, MIN, MAX].")
      }
      query_params[["aggregation"]] <- `aggregation`

      if (!is.null(`quantification`) && !(`quantification` %in% c("APEX_INTENSITY", "AREA_UNDER_CURVE"))) {
        stop("Invalid value for quantification when calling NPCClassStatisticsApi$DeleteNpcClassFoldChangesExperimental. Must be [APEX_INTENSITY, AREA_UNDER_CURVE].")
      }
      query_params[["quantification"]] <- `quantification`

      local_var_url_path <- "/api/projects/{projectId}/npc-classes/statistics/foldchanges"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
    ...
    GetNpcClassFoldChangeTableExperimental = function(project_id, aggregation = "AVG", quantification = "APEX_INTENSITY", data_file = NULL, ...) {
      local_var_response <- self$GetNpcClassFoldChangeTableExperimentalWithHttpInfo(project_id, aggregation, quantification, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    GetNpcClassFoldChangeTableExperimentalWithHttpInfo = function(project_id, aggregation = "AVG", quantification = "APEX_INTENSITY", data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!is.null(`aggregation`) && !(`aggregation` %in% c("AVG", "MIN", "MAX"))) {
        stop("Invalid value for aggregation when calling NPCClassStatisticsApi$GetNpcClassFoldChangeTableExperimental. Must be [AVG, MIN, MAX].")
      }
      query_params[["aggregation"]] <- `aggregation`

      if (!is.null(`quantification`) && !(`quantification` %in% c("APEX_INTENSITY", "AREA_UNDER_CURVE"))) {
        stop("Invalid value for quantification when calling NPCClassStatisticsApi$GetNpcClassFoldChangeTableExperimental. Must be [APEX_INTENSITY, AREA_UNDER_CURVE].")
      }
      query_params[["quantification"]] <- `quantification`

      local_var_url_path <- "/api/projects/{projectId}/npc-classes/statistics/foldchanges/stats-table"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
