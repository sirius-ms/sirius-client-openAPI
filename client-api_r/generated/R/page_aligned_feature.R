#' Create a new PageAlignedFeature
#'
#' @description
#' PageAlignedFeature Class
#'
#' @docType class
#' @title PageAlignedFeature
#' @description PageAlignedFeature Class
...
PageAlignedFeature <- R6::R6Class(
  ...
  public = list(
    ...
    `pageable` = NULL,
    `empty` = NULL,
    #' Initialize a new PageAlignedFeature class.
    #'
    #' @description
    #' Initialize a new PageAlignedFeature class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PageAlignedFeature in JSON format
    #' @export
    toJSON = function() {
      PageAlignedFeatureObject <- list()
      if (!is.null(self$`totalPages`)) {
        PageAlignedFeatureObject[["totalPages"]] <-
          self$`totalPages`
      }
      ...
      if (!is.null(self$`content`)) {
        PageAlignedFeatureObject[["content"]] <-
          lapply(self$`content`, function(x) x$toJSON())
      }
      if (!is.null(self$`number`)) {
        PageAlignedFeatureObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`numberOfElements`)) {
        PageAlignedFeatureObject[["numberOfElements"]] <-
          self$`numberOfElements`
      }
      if (!is.null(self$`pageable`)) {
        PageAlignedFeatureObject[["pageable"]] <-
          self$`pageable`$toJSON()
      }
      if (!is.null(self$`empty`)) {
        PageAlignedFeatureObject[["empty"]] <-
          self$`empty`
      }
      PageAlignedFeatureObject
    },
    #' Deserialize JSON string into an instance of PageAlignedFeature
    #'
    #' @description
    #' Deserialize JSON string into an instance of PageAlignedFeature
    #'
    #' @param input_json the JSON input
    #' @return the instance of PageAlignedFeature
    #' @export
...
',
    ...
    #' Validate JSON input with respect to PageAlignedFeature
    #'
    #' @description
    #' Validate JSON input with respect to PageAlignedFeature and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PageAlignedFeature
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PageAlignedFeature$unlock()
#
## Below is an example to define the print function
# PageAlignedFeature$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PageAlignedFeature$lock()
