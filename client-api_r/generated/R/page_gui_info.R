...
PageGuiInfo <- R6::R6Class(
  ...
  public = list(
    ...
    `last` = NULL,
    `empty` = NULL,
    #' Initialize a new PageGuiInfo class.
    #'
    #' @description
    #' Initialize a new PageGuiInfo class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PageGuiInfo in JSON format
    #' @export
    toJSON = function() {
      PageGuiInfoObject <- list()
      if (!is.null(self$`totalPages`)) {
        PageGuiInfoObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`totalElements`)) {
        PageGuiInfoObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`size`)) {
        PageGuiInfoObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`content`)) {
        PageGuiInfoObject[["content"]] <-
          lapply(self$`content`, function(x) x$toJSON())
      }
      if (!is.null(self$`number`)) {
        PageGuiInfoObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`sort`)) {
        PageGuiInfoObject[["sort"]] <-
          self$`sort`$toJSON()
      }
      if (!is.null(self$`numberOfElements`)) {
        PageGuiInfoObject[["numberOfElements"]] <-
          self$`numberOfElements`
      }
      if (!is.null(self$`pageable`)) {
        PageGuiInfoObject[["pageable"]] <-
          self$`pageable`$toJSON()
      }
      if (!is.null(self$`first`)) {
        PageGuiInfoObject[["first"]] <-
          self$`first`
      }
      if (!is.null(self$`last`)) {
        PageGuiInfoObject[["last"]] <-
          self$`last`
      }
      if (!is.null(self$`empty`)) {
        PageGuiInfoObject[["empty"]] <-
          self$`empty`
      }
      PageGuiInfoObject
    },
    #' Deserialize JSON string into an instance of PageGuiInfo
    #'
    #' @description
    #' Deserialize JSON string into an instance of PageGuiInfo
    #'
    #' @param input_json the JSON input
    #' @return the instance of PageGuiInfo
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`content`)) {
        self$`content` <- ApiClient$new()$deserializeObj(this_object$`content`, "array[GuiInfo]", loadNamespace("Rsirius"))
      }
...
',
    ...
    #' Validate JSON input with respect to PageGuiInfo
    #'
    #' @description
    #' Validate JSON input with respect to PageGuiInfo and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PageGuiInfo
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PageGuiInfo$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
