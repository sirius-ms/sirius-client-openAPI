#' Create a new PageProjectInfo
#'
#' @description
#' PageProjectInfo Class
#'
#' @docType class
#' @title PageProjectInfo
#' @description PageProjectInfo Class
#' @format An \code{R6Class} generator object
#' @field totalPages  integer [optional]
#' @field totalElements  integer [optional]
#' @field size  integer [optional]
#' @field content  list(\link{ProjectInfo}) [optional]
...
PageProjectInfo <- R6::R6Class(
  ...
  public = list(
    ...
    `last` = NULL,
    `empty` = NULL,
    #' Initialize a new PageProjectInfo class.
    #'
    #' @description
    #' Initialize a new PageProjectInfo class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PageProjectInfo in JSON format
    #' @export
    toJSON = function() {
      PageProjectInfoObject <- list()
      if (!is.null(self$`totalPages`)) {
        PageProjectInfoObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`totalElements`)) {
        PageProjectInfoObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`size`)) {
        PageProjectInfoObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`content`)) {
        PageProjectInfoObject[["content"]] <-
          lapply(self$`content`, function(x) x$toJSON())
      }
      if (!is.null(self$`number`)) {
        PageProjectInfoObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`sort`)) {
        PageProjectInfoObject[["sort"]] <-
          self$`sort`$toJSON()
      }
      if (!is.null(self$`numberOfElements`)) {
        PageProjectInfoObject[["numberOfElements"]] <-
          self$`numberOfElements`
      }
      if (!is.null(self$`pageable`)) {
        PageProjectInfoObject[["pageable"]] <-
          self$`pageable`$toJSON()
      }
      if (!is.null(self$`first`)) {
        PageProjectInfoObject[["first"]] <-
          self$`first`
      }
      if (!is.null(self$`last`)) {
        PageProjectInfoObject[["last"]] <-
          self$`last`
      }
      if (!is.null(self$`empty`)) {
        PageProjectInfoObject[["empty"]] <-
          self$`empty`
      }
      PageProjectInfoObject
    },
    #' Deserialize JSON string into an instance of PageProjectInfo
    #'
    #' @description
    #' Deserialize JSON string into an instance of PageProjectInfo
    #'
    #' @param input_json the JSON input
    #' @return the instance of PageProjectInfo
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`content`)) {
        self$`content` <- ApiClient$new()$deserializeObj(this_object$`content`, "array[ProjectInfo]", loadNamespace("Rsirius"))
      }
...
',
    ...
    #' Validate JSON input with respect to PageProjectInfo
    #'
    #' @description
    #' Validate JSON input with respect to PageProjectInfo and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PageProjectInfo
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PageProjectInfo$unlock()
#
## Below is an example to define the print function
# PageProjectInfo$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PageProjectInfo$lock()
