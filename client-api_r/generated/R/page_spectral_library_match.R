...
#'
#' @docType class
#' @title PageSpectralLibraryMatch
#' @description PageSpectralLibraryMatch Class
...
#' @export
PageSpectralLibraryMatch <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return PageSpectralLibraryMatch in JSON format
    #' @export
    toJSON = function() {
      PageSpectralLibraryMatchObject <- list()
      if (!is.null(self$`totalPages`)) {
        PageSpectralLibraryMatchObject[["totalPages"]] <-
          self$`totalPages`
      }
      ...
      if (!is.null(self$`content`)) {
        PageSpectralLibraryMatchObject[["content"]] <-
          lapply(self$`content`, function(x) x$toJSON())
      }
      if (!is.null(self$`number`)) {
        PageSpectralLibraryMatchObject[["number"]] <-
          self$`number`
      }
      ...
      PageSpectralLibraryMatchObject
    },
    ...
    #' @return the instance of PageSpectralLibraryMatch
    #' @export
...
',
    ...
    #' Validate JSON input with respect to PageSpectralLibraryMatch
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PageSpectralLibraryMatch
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PageSpectralLibraryMatch$unlock()
#
## Below is an example to define the print function
# PageSpectralLibraryMatch$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PageSpectralLibraryMatch$lock()
