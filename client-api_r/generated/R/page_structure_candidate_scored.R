...
PageStructureCandidateScored <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`totalPages` = NULL, `totalElements` = NULL, `size` = NULL, `content` = NULL, `number` = NULL, `sort` = NULL, `last` = NULL, `first` = NULL, `numberOfElements` = NULL, `pageable` = NULL, `empty` = NULL, ...) {
