#' Create a new PageStructureCandidateScored
#'
#' @description
#' PageStructureCandidateScored Class
#'
#' @docType class
#' @title PageStructureCandidateScored
#' @description PageStructureCandidateScored Class
...
#' @export
PageStructureCandidateScored <- R6::R6Class(
  ...
  public = list(
    ...
    `pageable` = NULL,
    `empty` = NULL,
    #' Initialize a new PageStructureCandidateScored class.
    #'
    #' @description
    #' Initialize a new PageStructureCandidateScored class.
    #'
    ...
    #' @export
    initialize = function(`totalPages` = NULL, `totalElements` = NULL, `size` = NULL, `content` = NULL, `number` = NULL, `sort` = NULL, `last` = NULL, `numberOfElements` = NULL, `first` = NULL, `pageable` = NULL, `empty` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return PageStructureCandidateScored in JSON format
    #' @export
    toJSON = function() {
      PageStructureCandidateScoredObject <- list()
      if (!is.null(self$`totalPages`)) {
        PageStructureCandidateScoredObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`totalElements`)) {
        PageStructureCandidateScoredObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`size`)) {
        PageStructureCandidateScoredObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`content`)) {
        PageStructureCandidateScoredObject[["content"]] <-
          lapply(self$`content`, function(x) x$toJSON())
      }
      if (!is.null(self$`number`)) {
        PageStructureCandidateScoredObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`sort`)) {
        PageStructureCandidateScoredObject[["sort"]] <-
          self$`sort`$toJSON()
      }
      if (!is.null(self$`last`)) {
        PageStructureCandidateScoredObject[["last"]] <-
          self$`last`
      }
      if (!is.null(self$`numberOfElements`)) {
        PageStructureCandidateScoredObject[["numberOfElements"]] <-
          self$`numberOfElements`
      }
      if (!is.null(self$`first`)) {
        PageStructureCandidateScoredObject[["first"]] <-
          self$`first`
      }
      if (!is.null(self$`pageable`)) {
        PageStructureCandidateScoredObject[["pageable"]] <-
          self$`pageable`$toJSON()
      }
      if (!is.null(self$`empty`)) {
        PageStructureCandidateScoredObject[["empty"]] <-
          self$`empty`
      }
      PageStructureCandidateScoredObject
    },
    #' Deserialize JSON string into an instance of PageStructureCandidateScored
    #'
    #' @description
    #' Deserialize JSON string into an instance of PageStructureCandidateScored
    #'
    #' @param input_json the JSON input
    #' @return the instance of PageStructureCandidateScored
    #' @export
...
',
    ...
    #' Validate JSON input with respect to PageStructureCandidateScored
    #'
    #' @description
    #' Validate JSON input with respect to PageStructureCandidateScored and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PageStructureCandidateScored
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PageStructureCandidateScored$unlock()
#
## Below is an example to define the print function
# PageStructureCandidateScored$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PageStructureCandidateScored$lock()
