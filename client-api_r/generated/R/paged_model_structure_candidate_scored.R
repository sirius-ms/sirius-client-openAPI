...
PagedModelStructureCandidateScored <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return PagedModelStructureCandidateScored as a base R list.
    #' @examples
    #' # convert array of PagedModelStructureCandidateScored (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PagedModelStructureCandidateScored to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(PagedModelStructureCandidateScoredObject)
    },
