...
#'
#' library(RSirius)
#' var_project_id <- "project_id_example" # character | unique name/identifier of the project-space to be accessed.
#' var_opt_fields <- c("none") # array[character] |  (Optional)
#'
...
#' var_parameters <- LcmsSubmissionParameters$new(c("sampleNames_example"), c("sampleTypes_example"), "alignLCMSRuns_example", 123, Deviation$new(123, 123), Deviation$new(123, 123), 123, 123) # LcmsSubmissionParameters | 
#'
...
#' var_path_to_project <- "path_to_project_example" # character | local file path to open the project from. If NULL, project will be loaded by its projectId from default project location. DEPRECATED: This parameter relies on the local filesystem and will likely be removed in later versions of this API to allow for more flexible use cases. (Optional)
#' var_opt_fields <- c("none") # array[character] |  (Optional)
#'
...
ProjectsApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetCanopusClassyFireDataWithHttpInfo = function(project_id, charge, data_file = NULL, ...) {
      ...
      # The Accept request HTTP header
      local_var_accepts <- list("application/csv", "application/CSV", "application/problem+json")
    ...
    #' Get project space info by its projectId.
    #'
    #' @param project_id unique name/identifier of the project-space to be accessed.
    #' @param opt_fields (optional) No description (default value: ["none"])
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #'
    ...
    #' @param path_to_project (optional) local file path to open the project from. If NULL, project will be loaded by its projectId from default project location. DEPRECATED: This parameter relies on the local filesystem and will likely be removed in later versions of this API to allow for more flexible use cases.
    #' @param opt_fields (optional) No description (default value: ["none"])
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #'
