...
ProjectsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ProjectInfo
    CopyProject = function(project_id, path_to_copied_project, copy_project_id = NULL, opt_fields = list("none"), data_file = NULL, ...) {
      local_var_response <- self$CopyProjectWithHttpInfo(project_id, path_to_copied_project, copy_project_id, opt_fields, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    CopyProjectWithHttpInfo = function(project_id, path_to_copied_project, copy_project_id = NULL, opt_fields = list("none"), data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      for (query_item in `opt_fields`) {
        ...
        if (!is.null(query_item) && !(query_item %in% c("none", "compatibilityInfo", "sizeInformation", "detectedAdducts"))) {
          stop("Invalid value for opt_fields when calling ProjectsApi$CopyProject. Must be [none, compatibilityInfo, sizeInformation, detectedAdducts].")
        }
    ...
    #'
    #' @return ProjectInfo
    Create = function(opt_fields = list("none"), data_file = NULL, ...) {
      local_var_response <- self$CreateWithHttpInfo(opt_fields, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #'
    #' @return API response (ProjectInfo) with additional information such as HTTP status code, headers
    CreateWithHttpInfo = function(opt_fields = list("none"), data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      for (query_item in `opt_fields`) {
        # validate enum values
        if (!is.null(query_item) && !(query_item %in% c("none", "compatibilityInfo", "sizeInformation", "detectedAdducts"))) {
          stop("Invalid value for opt_fields when calling ProjectsApi$Create. Must be [none, compatibilityInfo, sizeInformation, detectedAdducts].")
        }
        query_params[["optFields"]] <- c(query_params[["optFields"]], list(`optFields` = query_item))
      }

      local_var_url_path <- "/api/projects/create"
    ...
    #' @param request_body Local files to import into project.
    #' @param opt_fields (optional) Set of optional fields to be included. Use 'none' only to override defaults. (default value: ["progress"])
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #'
    #' @return Job
    ImportMsRunDataAsJobLocally = function(project_id, parameters, request_body, opt_fields = list("progress"), data_file = NULL, ...) {
      local_var_response <- self$ImportMsRunDataAsJobLocallyWithHttpInfo(project_id, parameters, request_body, opt_fields, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #'
    #' @return API response (Job) with additional information such as HTTP status code, headers
    ImportMsRunDataAsJobLocallyWithHttpInfo = function(project_id, parameters, request_body, opt_fields = list("progress"), data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      for (query_item in `opt_fields`) {
        # validate enum values
        if (!is.null(query_item) && !(query_item %in% c("none", "command", "progress", "affectedIds"))) {
          stop("Invalid value for opt_fields when calling ProjectsApi$ImportMsRunDataAsJobLocally. Must be [none, command, progress, affectedIds].")
        }
        query_params[["optFields"]] <- c(query_params[["optFields"]], list(`optFields` = query_item))
      }
    ...
    #'
    #' @return ImportResult
    ImportMsRunDataLocally = function(project_id, parameters, request_body, data_file = NULL, ...) {
      local_var_response <- self$ImportMsRunDataLocallyWithHttpInfo(project_id, parameters, request_body, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #'
    #' @return API response (ImportResult) with additional information such as HTTP status code, headers
    ImportMsRunDataLocallyWithHttpInfo = function(project_id, parameters, request_body, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/api/projects/{projectId}/import/ms-local-data-files"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
    ...
    #'
    #' @return Job
    ImportPreprocessedDataAsJobLocally = function(project_id, request_body, ignore_formulas = FALSE, allow_ms1_only = TRUE, opt_fields = list("progress"), data_file = NULL, ...) {
      local_var_response <- self$ImportPreprocessedDataAsJobLocallyWithHttpInfo(project_id, request_body, ignore_formulas, allow_ms1_only, opt_fields, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #'
    #' @return API response (Job) with additional information such as HTTP status code, headers
    ImportPreprocessedDataAsJobLocallyWithHttpInfo = function(project_id, request_body, ignore_formulas = FALSE, allow_ms1_only = TRUE, opt_fields = list("progress"), data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      for (query_item in `opt_fields`) {
        # validate enum values
        if (!is.null(query_item) && !(query_item %in% c("none", "command", "progress", "affectedIds"))) {
          stop("Invalid value for opt_fields when calling ProjectsApi$ImportPreprocessedDataAsJobLocally. Must be [none, command, progress, affectedIds].")
        }
        query_params[["optFields"]] <- c(query_params[["optFields"]], list(`optFields` = query_item))
      }
      ...
      local_var_url_path <- "/api/projects/{projectId}/import/preprocessed-local-data-files-job"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
    ...
    #'
    #' @param project_id project-space to import into.
    #' @param request_body files to import into project
    #' @param ignore_formulas (optional) No description (default value: FALSE)
    #' @param allow_ms1_only (optional) No description (default value: TRUE)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #'
    #' @return ImportResult
    ImportPreprocessedDataLocally = function(project_id, request_body, ignore_formulas = FALSE, allow_ms1_only = TRUE, data_file = NULL, ...) {
      local_var_response <- self$ImportPreprocessedDataLocallyWithHttpInfo(project_id, request_body, ignore_formulas, allow_ms1_only, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #'
    #' @return API response (ImportResult) with additional information such as HTTP status code, headers
    ImportPreprocessedDataLocallyWithHttpInfo = function(project_id, request_body, ignore_formulas = FALSE, allow_ms1_only = TRUE, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/api/projects/{projectId}/import/preprocessed-local-data-files"
      if (!missing(`project_id`)) {
        local_var_url_path <- gsub("\\{projectId\\}", URLencode(as.character(`project_id`), reserved = TRUE), local_var_url_path)
      }
