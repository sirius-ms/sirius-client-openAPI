...
ProjectsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ProjectInfo
    CreateProject = function(project_id, path_to_project = NULL, opt_fields = [none], data_file = NULL, ...) {
    ...
    CreateProjectWithHttpInfo = function(project_id, path_to_project = NULL, opt_fields = [none], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return Job
    ImportMsRunDataAsJob = function(project_id, input_files, parameters, opt_fields = [progress], data_file = NULL, ...) {
    ...
    ImportMsRunDataAsJobWithHttpInfo = function(project_id, input_files, parameters, opt_fields = [progress], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return Job
    ImportPreprocessedDataAsJob = function(project_id, input_files, ignore_formulas = FALSE, allow_ms1_only = TRUE, opt_fields = [progress], data_file = NULL, ...) {
    ...
    #'
    #' @return API response (Job) with additional information such as HTTP status code, headers
    ImportPreprocessedDataAsJobWithHttpInfo = function(project_id, input_files, ignore_formulas = FALSE, allow_ms1_only = TRUE, opt_fields = [progress], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return ProjectInfo
    OpenProject = function(project_id, path_to_project = NULL, opt_fields = [none], data_file = NULL, ...) {
    ...
    #'
    #' @return API response (ProjectInfo) with additional information such as HTTP status code, headers
    OpenProjectWithHttpInfo = function(project_id, path_to_project = NULL, opt_fields = [none], data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
