...
#' }
#'
#' \strong{ ImportMsRunDataAsJobLocally } \emph{ Import and Align full MS-Runs from various formats into the specified project as background job }
...
#' }
#'
#' \strong{ ImportMsRunDataLocally } \emph{ Import and Align full MS-Runs from various formats into the specified project  Possible formats (mzML, mzXML) }
...
#' }
#'
#' \strong{ ImportPreprocessedDataAsJobLocally } \emph{ Import ms/ms data from the given format into the specified project-space as background job }
...
#' }
#'
#' \strong{ ImportPreprocessedDataLocally } \emph{ Import already preprocessed ms/ms data from various formats into the specified project  Possible formats (ms, mgf, cef, msp) }
...
ProjectsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return Job
    #' @export
    ImportMsRunDataAsJobLocally = function(project_id, parameters, request_body, allow_ms1_only = TRUE, opt_fields = list("progress"), data_file = NULL, ...) {
      local_var_response <- self$ImportMsRunDataAsJobLocallyWithHttpInfo(project_id, parameters, request_body, allow_ms1_only, opt_fields, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (Job) with additional information such as HTTP status code, headers
    #' @export
    ImportMsRunDataAsJobLocallyWithHttpInfo = function(project_id, parameters, request_body, allow_ms1_only = TRUE, opt_fields = list("progress"), data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #' @return ImportResult
    #' @export
    ImportMsRunDataLocally = function(project_id, parameters, request_body, allow_ms1_only = TRUE, data_file = NULL, ...) {
      local_var_response <- self$ImportMsRunDataLocallyWithHttpInfo(project_id, parameters, request_body, allow_ms1_only, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
    ...
    #' @return API response (ImportResult) with additional information such as HTTP status code, headers
    #' @export
    ImportMsRunDataLocallyWithHttpInfo = function(project_id, parameters, request_body, allow_ms1_only = TRUE, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
