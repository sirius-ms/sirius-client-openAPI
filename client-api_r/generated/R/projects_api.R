...
#' \item \emph{ @param } opt_fields Enum < [none, compatibilityInfo, sizeInformation] >
...
#' \itemize{
#' \item \emph{ @param } project_id character
#' \item \emph{ @param } opt_fields Enum < [none, command, progress, affectedIds] >
#' \item \emph{ @param } input_files list( data.frame )
#' \item \emph{ @param } parameters \link{LcmsSubmissionParameters}
  ...
  public = list(
    ...
    CreateProjectSpaceWithHttpInfo = function(project_id, path_to_project = NULL, opt_fields = list(), data_file = NULL, ...) {
      ...
      for (query_item in `opt_fields`) {
        ...
        if (!(query_item %in% c("none", "compatibilityInfo", "sizeInformation"))) {
    ...
    ImportMsRunDataAsJobWithHttpInfo = function(project_id, opt_fields = list("progress"), input_files = NULL, parameters = NULL, data_file = NULL, ...) {
      ...
      for (query_item in `opt_fields`) {
        # validate enum values
        if (!(query_item %in% c("none", "command", "progress", "affectedIds"))) {
