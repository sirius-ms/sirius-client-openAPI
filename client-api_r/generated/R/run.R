...
#' @field name Informative, human-readable name of the run character [optional]
#' @field source Source location character [optional]
#' @field chromatography Chromatography the run was measured with, e.g. 'Liquid Chromatography'. character [optional]
#' @field ionization Ionization the run was measured with, named as in the HUPO PSI-MS controlled vocabulary,  e.g. 'electrospray ionization'. character [optional]
#' @field fragmentation Fragmentation the run was measured with, named as in the HUPO PSI-MS controlled vocabulary,  e.g. 'beam-type collision-induced dissociation'. character [optional]
#' @field massAnalyzers Mass analyzers of the instrument the run was measured on, named as in the HUPO PSI-MS  controlled vocabulary, e.g. 'orbitrap'. list(character) [optional]
...
Run <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param name Informative, human-readable name of the run
    #' @param source Source location
    #' @param chromatography Chromatography the run was measured with, e.g. 'Liquid Chromatography'.
    #' @param ionization Ionization the run was measured with, named as in the HUPO PSI-MS controlled vocabulary,  e.g. 'electrospray ionization'.
    #' @param fragmentation Fragmentation the run was measured with, named as in the HUPO PSI-MS controlled vocabulary,  e.g. 'beam-type collision-induced dissociation'.
    #' @param massAnalyzers Mass analyzers of the instrument the run was measured on, named as in the HUPO PSI-MS  controlled vocabulary, e.g. 'orbitrap'.
