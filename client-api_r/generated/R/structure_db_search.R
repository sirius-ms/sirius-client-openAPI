...
#' @field structureSearchDBs Structure databases to search in, If expansive search is enabled this DB selection will be expanded to PubChem  if no high confidence hit was found in the selected databases.  <p>  Defaults to BIO + Custom Databases. Possible values are available via the Database API. list(character) [optional]
...
StructureDbSearch <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param structureSearchDBs Structure databases to search in, If expansive search is enabled this DB selection will be expanded to PubChem  if no high confidence hit was found in the selected databases.  <p>  Defaults to BIO + Custom Databases. Possible values are available via the Database API.
