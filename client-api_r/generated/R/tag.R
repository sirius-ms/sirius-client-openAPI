...
#' @field tagName Name of the tag as defined by the corresponding TagDefinition  Links the tag object to its definition. character
...
Tag <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @param tagName Name of the tag as defined by the corresponding TagDefinition  Links the tag object to its definition.
    #' @param value value
