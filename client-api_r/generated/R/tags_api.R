  ...
  public = list(
    ...
    AddGroupWithHttpInfo = function(project_id, group_name, filter, type, data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling TagsApi$AddGroup, `project_id` is not nullable")
      }

      if (!missing(`group_name`) && is.null(`group_name`)) {
        stop("Invalid value for `group_name` when calling TagsApi$AddGroup, `group_name` is not nullable")
      }

      if (!missing(`filter`) && is.null(`filter`)) {
        stop("Invalid value for `filter` when calling TagsApi$AddGroup, `filter` is not nullable")
      }

      if (!missing(`type`) && is.null(`type`)) {
        stop("Invalid value for `type` when calling TagsApi$AddGroup, `type` is not nullable")
      }
    ...
    AddPossibleValuesToTagDefinitionWithHttpInfo = function(project_id, tag_name, request_body, data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling TagsApi$AddPossibleValuesToTagDefinition, `project_id` is not nullable")
      }

      if (!missing(`tag_name`) && is.null(`tag_name`)) {
        stop("Invalid value for `tag_name` when calling TagsApi$AddPossibleValuesToTagDefinition, `tag_name` is not nullable")
      }

      if (!missing(`request_body`) && is.null(`request_body`)) {
        stop("Invalid value for `request_body` when calling TagsApi$AddPossibleValuesToTagDefinition, `request_body` is not nullable")
      }
    ...
    CreateTagsWithHttpInfo = function(project_id, tag_definition_import, data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling TagsApi$CreateTags, `project_id` is not nullable")
      }

      if (!missing(`tag_definition_import`) && is.null(`tag_definition_import`)) {
        stop("Invalid value for `tag_definition_import` when calling TagsApi$CreateTags, `tag_definition_import` is not nullable")
      }
    ...
    DeleteGroupWithHttpInfo = function(project_id, group_name, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling TagsApi$DeleteGroup, `project_id` is not nullable")
      }

      if (!missing(`group_name`) && is.null(`group_name`)) {
        stop("Invalid value for `group_name` when calling TagsApi$DeleteGroup, `group_name` is not nullable")
      }
    ...
    DeleteTagWithHttpInfo = function(project_id, tag_name, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling TagsApi$DeleteTag, `project_id` is not nullable")
      }

      if (!missing(`tag_name`) && is.null(`tag_name`)) {
        stop("Invalid value for `tag_name` when calling TagsApi$DeleteTag, `tag_name` is not nullable")
      }
    ...
    GetGroupByNameWithHttpInfo = function(project_id, group_name, data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling TagsApi$GetGroupByName, `project_id` is not nullable")
      }

      if (!missing(`group_name`) && is.null(`group_name`)) {
        stop("Invalid value for `group_name` when calling TagsApi$GetGroupByName, `group_name` is not nullable")
      }
    ...
    GetGroupsWithHttpInfo = function(project_id, group_type = NULL, data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling TagsApi$GetGroups, `project_id` is not nullable")
      }

      if (!missing(`group_type`) && is.null(`group_type`)) {
        stop("Invalid value for `group_type` when calling TagsApi$GetGroups, `group_type` is not nullable")
      }
    ...
    GetTagWithHttpInfo = function(project_id, tag_name, data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling TagsApi$GetTag, `project_id` is not nullable")
      }

      if (!missing(`tag_name`) && is.null(`tag_name`)) {
        stop("Invalid value for `tag_name` when calling TagsApi$GetTag, `tag_name` is not nullable")
      }
    ...
    GetTagsWithHttpInfo = function(project_id, tag_type = NULL, data_file = NULL, ...) {
      ...
      if (!missing(`project_id`) && is.null(`project_id`)) {
        stop("Invalid value for `project_id` when calling TagsApi$GetTags, `project_id` is not nullable")
      }

      if (!missing(`tag_type`) && is.null(`tag_type`)) {
        stop("Invalid value for `tag_type` when calling TagsApi$GetTags, `tag_type` is not nullable")
      }
