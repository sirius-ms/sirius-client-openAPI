...
- API version: 3.1
- Package version: 6.3.3-SNAPSHOT
...
cd GIT_REPO_ID
R CMD build .
R CMD check Rsirius_6.3.3-SNAPSHOT.tar.gz --no-manual
R CMD INSTALL --preclean Rsirius_6.3.3-SNAPSHOT.tar.gz
```
...
```R
install.packages("Rsirius_6.3.3-SNAPSHOT.tar.gz", repos = NULL, type = "source")
```
