...
cd GIT_REPO_ID
R CMD build .
R CMD check Rsirius_2.1+sirius6.0.2.tar.gz --no-manual
R CMD INSTALL --preclean Rsirius_2.1+sirius6.0.2.tar.gz
```
...
```R
install.packages("Rsirius_2.1+sirius6.0.2.tar.gz", repos = NULL, type = "source")
```
