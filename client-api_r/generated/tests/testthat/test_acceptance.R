...
test_that("Test Acceptance", {
  ...
  formula_candidate <- features_api$GetAlignedFeature(project_id, job_submission$alignedFeatureIds[[1]], opt_fields=list("topAnnotations"))$topAnnotations$formulaAnnotation
