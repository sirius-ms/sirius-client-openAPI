...
test_that("spectrumAnnotation", {
  # tests for the property `spectrumAnnotation` (SpectrumAnnotation)

  # uncomment below to test the property
  #expect_equal(model.instance$`spectrumAnnotation`, "EXPECTED_RESULT")
})
