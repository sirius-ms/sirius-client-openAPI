...
test_that("GetAlignedFeaturesPage", {
  # tests for GetAlignedFeaturesPage
  # base path: http://localhost:8080
  # Get all available features (aligned over runs) in the given project-space.
  # Get all available features (aligned over runs) in the given project-space.
  # @param project_id character project-space to read from.
  ...
  tryCatch({
    ...
    project_id <- "GetAlignedFeaturesPage"
    projects_api$OpenProject(project_id, tomato_project)

    response <- api_instance$GetAlignedFeaturesPage(project_id)
...
test_that("GetDeNovoStructureCandidatesByFormulaPage", {
  # tests for GetDeNovoStructureCandidatesByFormulaPage
  # base path: http://localhost:8080
  ...
  tryCatch({
    ...
    project_id <- "GetDeNovoStructureCandidatesByFormulaPage"
    projects_api$OpenProject(project_id, tomato_project)
    formula_id <- api_instance$GetFormulaCandidates(project_id, aligned_feature_id)[[1]]$formulaId

    response <- api_instance$GetDeNovoStructureCandidatesByFormulaPage(project_id, aligned_feature_id, formula_id)
...
test_that("GetDeNovoStructureCandidatesPage", {
  # tests for GetDeNovoStructureCandidatesPage
  # base path: http://localhost:8080
  ...
  tryCatch({
    ...
    project_id <- "GetDeNovoStructureCandidatesPage"
    projects_api$OpenProject(project_id, tomato_project)

    response <- api_instance$GetDeNovoStructureCandidatesPage(project_id, aligned_feature_id)
...
test_that("GetFormulaCandidatesPage", {
  # tests for GetFormulaCandidatesPage
  # base path: http://localhost:8080
  ...
  tryCatch({
    ...
    project_id <- "GetFormulaCandidatesPage"
    projects_api$OpenProject(project_id, tomato_project)

    response <- api_instance$GetFormulaCandidatesPage(project_id, aligned_feature_id)
...
test_that("GetSpectralLibraryMatchesPage", {
  # tests for GetSpectralLibraryMatchesPage
  # base path: http://localhost:8080
  ...
  tryCatch({
    ...
    project_id <- "GetSpectralLibraryMatchesPage"
    projects_api$OpenProject(project_id, tomato_project)

    response <- api_instance$GetSpectralLibraryMatchesPage(project_id, aligned_feature_id)
...
test_that("GetStructureCandidatesByFormulaPage", {
  # tests for GetStructureCandidatesByFormulaPage
  # base path: http://localhost:8080
  ...
  tryCatch({
    ...
    project_id <- "GetStructureCandidatesByFormulaPage"
    projects_api$OpenProject(project_id, tomato_project)
    formula_id <- api_instance$GetFormulaCandidates(project_id, aligned_feature_id)[[1]]$formulaId

    response <- api_instance$GetStructureCandidatesByFormulaPage(project_id, aligned_feature_id, formula_id)
    expect_true(inherits(response, "PagedModelStructureCandidateScored"))
...
test_that("GetStructureCandidatesPage", {
  # tests for GetStructureCandidatesPage
  # base path: http://localhost:8080
  ...
  tryCatch({
    ...
    project_id <- "GetStructureCandidatesPage"
    projects_api$OpenProject(project_id, tomato_project)

    response <- api_instance$GetStructureCandidatesPage(project_id, aligned_feature_id)
    expect_true(inherits(response, "PagedModelStructureCandidateFormula"))
...
test_that("GetAlignedFeaturesPaged (deprecated alias)", {
  ...
  tryCatch({
    ...
    project_id <- "GetAlignedFeaturesPagedAlias"
    projects_api$OpenProject(project_id, tomato_project)

    expect_warning(response <- api_instance$GetAlignedFeaturesPaged(project_id), "renamed")
    expect_true(inherits(response, "PagedModelAlignedFeature"))
