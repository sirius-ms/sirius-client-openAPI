...
module RubySirius
  ...
  class JobProgress
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('String', ["WAITING", "READY", "QUEUED", "SUBMITTED", "RUNNING", "CANCELED", "FAILED", "DONE"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["WAITING", "READY", "QUEUED", "SUBMITTED", "RUNNING", "CANCELED", "FAILED", "DONE"])
