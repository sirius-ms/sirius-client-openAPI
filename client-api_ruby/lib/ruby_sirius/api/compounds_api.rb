...
module RubySirius
  class CompoundsApi
    ...
    def delete_compound_with_http_info(project_id, cid, opts = {})
      ...
      # resource path
      local_var_path = '/api/projects/{projectId}/compounds/{cid}'.sub('{' + 'projectId' + '}', project_id.to_s).sub('{' + 'cid' + '}', cid.to_s)
    ...
    def get_compound_with_http_info(project_id, cid, opts = {})
      ...
      return_type = opts[:return_type] || 'CompoundId' 
    ...
    def get_compounds_with_http_info(project_id, opts = {})
      ...
      # resource path
      local_var_path = '/api/projects/{projectId}/compounds'.sub('{' + 'projectId' + '}', project_id.to_s)
      ...
      return_type = opts[:return_type] || 'Array<CompoundId>' 
    ...
    # @return [JobId]
    def import_compounds(body, project_id, opts = {})
      data, _status_code, _headers = import_compounds_with_http_info(body, project_id, opts)
      data
    end
    ...
    def import_compounds_with_http_info(body, project_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompoundsApi.import_compounds ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CompoundsApi.import_compounds"
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
    ...
    # @return [Array<CompoundId>]
    def import_compounds_from_string(body, format, project_id, opts = {})
      data, _status_code, _headers = import_compounds_from_string_with_http_info(body, format, project_id, opts)
      data
    end
    ...
    # @option opts [String] :source_name name that specifies the data source. Can e.g. be a file path or just a name.
    # @return [Array<(Array<CompoundId>, Integer, Hash)>] Array<CompoundId> data, response status code and response headers
    def import_compounds_from_string_with_http_info(body, format, project_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/projects/{projectId}/compounds/import-from-string'.sub('{' + 'projectId' + '}', project_id.to_s)
