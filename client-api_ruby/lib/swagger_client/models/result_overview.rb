  ...
  class ResultOverview
    ...
    def self.openapi_types
      {
        :'sirius_score' => :'Object',
        :'zodiac_score' => :'Object',
        :'top_csi_score' => :'Object',
        :'confidence_score' => :'Object',
        :'canopus_result' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ResultOverview` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ResultOverview`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'top_csi_score')
        self.top_csi_score = attributes[:'top_csi_score']
      end
      ...
      if attributes.key?(:'canopus_result')
        self.canopus_result = attributes[:'canopus_result']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          top_csi_score == o.top_csi_score &&
          confidence_score == o.confidence_score &&
          canopus_result == o.canopus_result
    end
    ...
    def hash
      [sirius_score, zodiac_score, top_csi_score, confidence_score, canopus_result].hash
    end
