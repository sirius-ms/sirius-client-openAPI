...
# Unit tests for SwaggerClient::FormulaResultsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FormulaResultsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::FormulaResultsApi.new
  end
  ...
  describe 'test an instance of FormulaResultsApi' do
    it 'should create an instance of FormulaResultsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::FormulaResultsApi)
    end
  end
