...
# Unit tests for SwaggerClient::GraphicalUserInterfaceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GraphicalUserInterfaceApi' do
  before do
    # run before each test
    @instance = SwaggerClient::GraphicalUserInterfaceApi.new
  end
  ...
  describe 'test an instance of GraphicalUserInterfaceApi' do
    it 'should create an instance of GraphicalUserInterfaceApi' do
      expect(@instance).to be_instance_of(SwaggerClient::GraphicalUserInterfaceApi)
    end
  end
