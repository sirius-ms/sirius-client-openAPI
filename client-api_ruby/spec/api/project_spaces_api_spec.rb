...
# Unit tests for SwaggerClient::ProjectSpacesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectSpacesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ProjectSpacesApi.new
  end
  ...
  describe 'test an instance of ProjectSpacesApi' do
    it 'should create an instance of ProjectSpacesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ProjectSpacesApi)
    end
  end
