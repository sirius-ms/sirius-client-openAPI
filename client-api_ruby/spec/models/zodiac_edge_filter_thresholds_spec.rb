...
# Unit tests for RubySirius::ZodiacEdgeFilterThresholds
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZodiacEdgeFilterThresholds' do
  before do
    # run before each test
    @instance = RubySirius::ZodiacEdgeFilterThresholds.new
  end
  ...
  describe 'test an instance of ZodiacEdgeFilterThresholds' do
    it 'should create an instance of ZodiacEdgeFilterThresholds' do
      expect(@instance).to be_instance_of(RubySirius::ZodiacEdgeFilterThresholds)
    end
  end
