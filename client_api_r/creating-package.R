...
cat(paste("Directories",package_name,",",file.path(package_name,"man"),"and",file.path(package_name,"R"),"created."))
...
files_to_copy <- c(path_gen_scripts,file.path(getwd(),"SiriusApi.R"))
...
cat(paste("Copied all R scripts into",file.path(getwd(),package_name,"R"),"."))
...
cat(paste("Copied the DESCRIPTION and LICENSE file into",file.path(getwd(),package_name),"."))
...
cat("Created the NAMESPACE file and all .Rd help files.")
...
cat("Copied the .Rd help file for the whole R package.")

cat("FINISHED WITH CREATING PACKAGE")